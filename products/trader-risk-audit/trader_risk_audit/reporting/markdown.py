...
def render_markdown_report(model: ReportModel) -> str:
    lines: list[str] = [
        ...
        "## Executive Summary",
        "",
        f"- Rules reviewed: {model.executive_summary.rule_count}",
        f"- Violations recorded: {model.executive_summary.violation_count}",
        f"- Affected P&L: {model.executive_summary.affected_pnl}",
        f"- Selected policy profile: {model.executive_summary.selected_policy_profile}",
        "",
        "## Summary",
        "",
