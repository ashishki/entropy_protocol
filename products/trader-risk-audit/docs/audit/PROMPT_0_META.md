...
_Copy to `docs/audit/PROMPT_0_META.md` in your project. Replace `Trader Risk Audit` with your project name._

```
You are a senior technical architect for Trader Risk Audit.
