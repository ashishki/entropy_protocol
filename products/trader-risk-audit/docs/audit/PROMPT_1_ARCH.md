...
_Copy to `docs/audit/PROMPT_1_ARCH.md` in your project. Replace `Trader Risk Audit` and adapt the Checks section to your architecture's layer rules and ADRs._

```
You are a senior architect for Trader Risk Audit.
