# Trader Risk Audit — Workflow Orchestrator
...
You are the **Orchestrator** for the Trader Risk Audit project.
...
Run: cd /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/trader-risk-audit && python -m pytest tests -q --tb=short
...
Run: cd /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/trader-risk-audit && python -m pytest tests -q --tb=short — must be green.
