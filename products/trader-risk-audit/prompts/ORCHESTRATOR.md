...
Set `CURRENT_TASK` only for shell validation commands when useful, then continue in the current product Codex session using the working brief above. Do not call `codex`, `codex exec` or another AI process.
