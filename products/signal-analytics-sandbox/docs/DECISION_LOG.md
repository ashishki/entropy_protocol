...
| D-015 | 2026-05-07 | Active | Phase 10 approved as a narrow deterministic draft-extraction assistant, starting with seed labels | The 60 captured posts create a concrete extraction bottleneck. Automation is limited to reviewable parser suggestions; no auto-approved ledger writes, bot ingestion, private scraping, or LLM truth. | `docs/pilot/AUTO_EXTRACTION_DEVELOPMENT_PLAN.md`, `docs/tasks.md#phase-10--draft-extraction-assistant-for-captured-telegram-posts` | none |
| D-016 | 2026-05-07 | Active | Frontier model may be used offline for author-specific lexicon discovery before parser implementation | A short hard-coded Russian trading lexicon is likely to miss each author's idioms. Model output is allowed only as evidence-cited candidate vocabulary that a human approves, rejects, or defers; runtime parser, exports, tests, and ledger writes remain deterministic and non-LLM. | `docs/tasks.md#sas-auto-001b-llm-assisted-author-lexicon-discovery`, `docs/pilot/AUTO_EXTRACTION_DEVELOPMENT_PLAN.md` | none |
