# Signal Analytics Sandbox — Workflow Orchestrator
...
<!-- codex exec -s workspace-write is the implementation agent invocation.
     ...
     files under /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox, and execute shell commands (test runner, linter). -->
...
cd /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox && codex exec -s workspace-write "$PROMPT"
```
...
You are the **Orchestrator** for the Signal Analytics Sandbox project.
...
Project root: `/home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox`
...
```
You are the Phase 1 Validator for Signal Analytics Sandbox.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox
...
```
You are the implementation agent for Signal Analytics Sandbox.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox
...
Run: cd /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox && [YOUR_TEST_COMMAND]
...
```
You are the Light Reviewer for Signal Analytics Sandbox.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox
...
Use **Agent tool** (`general-purpose`):
```
You are the META Analyst for Signal Analytics Sandbox.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox
...
Use **Agent tool** (`general-purpose`):
```
You are the Architecture Reviewer for Signal Analytics Sandbox.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox
...
Use **Agent tool** (`general-purpose`):
```
You are the Code Reviewer for Signal Analytics Sandbox.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox
...
Use **Agent tool** (`general-purpose`):
```
You are the Consolidation Agent for Signal Analytics Sandbox.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox
...
Write to `/tmp/orchestrator_codex_prompt.txt`:
```
You are the Fixer for Signal Analytics Sandbox.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox
...
Write to `/tmp/orchestrator_codex_prompt.txt`:
```
You are the Fix agent for Signal Analytics Sandbox.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox
...
Run: cd /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox && [YOUR_TEST_COMMAND] — must be green.
...
```
You are the Doc Updater for Signal Analytics Sandbox.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox
...
|---|---|---|
| `Signal Analytics Sandbox` | Human-readable project name used in agent system prompts | `my-api-service` |
| `/home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox` | Absolute path to the repository root on disk | `/home/alice/my-api-service` |
...
2. Can read and write files under `/home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/signal-analytics-sandbox`
