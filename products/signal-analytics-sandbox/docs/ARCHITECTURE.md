...
| Auto-validation evidence engine | `src/signal_sandbox/auto_validation/` | Planned Phases 40-42 subsystem for candidate evidence bundles, validator results, audit logs, strict auto-accept decisions, and customer-facing policy gates. Model review remains triage; deterministic validators own acceptance proof. |
