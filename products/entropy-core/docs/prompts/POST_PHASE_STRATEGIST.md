...
- `products/entropy-core/docs/core/PROTOCOL_SPEC.md` — protocol intent, non-negotiables, metrics,
  governance semantics.
- `products/entropy-core/docs/core/CHARTER.md` — strategic direction and frozen decisions.
- `products/entropy-core/docs/core/GLOSSARY.md` — canonical vocabulary and metric definitions.
- `products/entropy-core/docs/ARCHITECTURE.md` — implemented system architecture and boundaries.
- `products/entropy-core/docs/spec.md` — feature specification and out-of-scope boundaries.
- `products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md` — immutable implementation rules.
- `products/entropy-core/docs/tasks.md` — completed and upcoming task graph.
- `products/entropy-core/docs/CODEX_PROMPT.md` — current state, baseline, open findings, next task.
- `products/entropy-core/docs/DECISION_LOG.md` — decision index; use only as retrieval aid.
- `products/entropy-core/docs/IMPLEMENTATION_JOURNAL.md` — implementation continuity context.
- `products/entropy-core/docs/EVIDENCE_INDEX.md` — test/evidence lookup.
- Latest relevant audit/review artifacts in `products/entropy-core/docs/audit/`, especially:
  - `products/entropy-core/docs/audit/REVIEW_REPORT.md`
  - latest `products/entropy-core/docs/audit/PHASE*_REVIEW.md`
...
- Does the implementation match `products/entropy-core/docs/ARCHITECTURE.md` component boundaries?
...
- objective;
- phase boundaries;
- tasks to add/update in `products/entropy-core/docs/tasks.md`;
...
- `products/entropy-core/docs/audit/PHASE{N}_STRATEGY_REVIEW.md`
...
- ADRs in `products/entropy-core/docs/adr/`
...
1. `products/entropy-core/docs/audit/archive/phase0/POST_PHASE_STRATEGY_REVIEW.md`
...
2. `products/entropy-core/docs/audit/archive/phase0/NEXT_PHASE_PLAN.md`
