# Entropy Core — Workflow Orchestrator
...
<!-- codex exec -s workspace-write is the implementation agent invocation.
     ...
     files under /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core, and execute shell commands (test runner, linter). -->
...
cd /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core && codex exec -s workspace-write "$PROMPT"
```
...
You are the **Orchestrator** for the Entropy Core project.
...
Project root: `/home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core`
...
```
You are the Phase 1 Validator for Entropy Core.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core
...
```
You are the implementation agent for Entropy Core.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core
...
Run: cd /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core && python -m pytest -q tests/
...
Protocol:
1. Run python -m pytest -q tests/ → record baseline BEFORE any changes
...
5. Run python -m pytest -q tests/ after → must not decrease passing count
...
```
You are the Light Reviewer for Entropy Core.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core
...
Use **Agent tool** (`general-purpose`):
```
You are the META Analyst for Entropy Core.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core
...
Use **Agent tool** (`general-purpose`):
```
You are the Architecture Reviewer for Entropy Core.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core
...
Use **Agent tool** (`general-purpose`):
```
You are the Code Reviewer for Entropy Core.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core
...
Use **Agent tool** (`general-purpose`):
```
You are the Consolidation Agent for Entropy Core.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core
...
Write to `/tmp/orchestrator_codex_prompt.txt`:
```
You are the Fixer for Entropy Core.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core
...
Write to `/tmp/orchestrator_codex_prompt.txt`:
```
You are the Fix agent for Entropy Core.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core
...
Run: cd /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core && python -m pytest -q tests/ — must be green.
...
```
You are the Doc Updater for Entropy Core.
Project root: /home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core
...
<!-- none — local sandbox, no out-of-band notifications is optional. It represents any out-of-band notification
...
Notification delivery (adapt or remove for none — local sandbox, no out-of-band notifications):
```bash
...
|---|---|---|
| `Entropy Core` | Human-readable project name used in agent system prompts | `my-api-service` |
| `/home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core` | Absolute path to the repository root on disk | `/home/alice/my-api-service` |
...
2. Can read and write files under `/home/ashishki/Documents/dev/ai-stack/projects/Entropy_Protocol/products/entropy-core`
...
Also replace `python -m pytest -q tests/` and `[YOUR_LINT_COMMAND]` in Steps 2, 3, and 5 with the actual commands for your project (e.g. `pytest tests/ -q` and `ruff check app/ tests/`).

**`none — local sandbox, no out-of-band notifications` — notification options:**
