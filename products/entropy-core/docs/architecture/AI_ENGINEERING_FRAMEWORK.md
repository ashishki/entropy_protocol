...
```
1. products/entropy-core/docs/core/GLOSSARY.md
2. products/entropy-core/docs/core/PROTOCOL_SPEC.md (or relevant sections)
3. products/entropy-core/docs/core/CHARTER.md (Non-Negotiables section minimum)
```

**Extended context for design sessions:**
```
4. products/entropy-core/docs/core/EVOLUTION.md
5. products/entropy-core/docs/README.md
```

**Minimal context for implementation-only sessions:**
```
1. products/entropy-core/docs/core/GLOSSARY.md
2. Specific `products/entropy-core/docs/core/PROTOCOL_SPEC.md` section relevant to the component
```
...
Current date: [DATE]
Active documents: products/entropy-core/docs/core/PROTOCOL_SPEC.md, products/entropy-core/docs/core/CHARTER.md
Frozen constraints: NN-1 through NN-6 (see products/entropy-core/docs/core/PROTOCOL_SPEC.md Section B)
```
...
If you need to reference a specific historical decision, load `products/entropy-core/docs/core/EVOLUTION.md` instead.
...
`products/entropy-core/docs/core/PROTOCOL_SPEC.md` defines what the system must do. It is the authoritative source for:
...
Do not create documents that duplicate content from `products/entropy-core/docs/core/PROTOCOL_SPEC.md` or `products/entropy-core/docs/core/CHARTER.md`. Reference those documents instead.
...
2. `products/entropy-core/docs/core/PROTOCOL_SPEC.md` (full)
3. `products/entropy-core/docs/core/EVOLUTION.md` (design history)
