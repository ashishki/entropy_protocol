...
Aggregate dataset hash: PENDING_T16_ARCHIVE_DATASET_HASH_FROM_LOCAL_FIXTURE
Manifest hash: PENDING_T16_ARCHIVE_DATASET_MANIFEST_HASH_FROM_LOCAL_FIXTURE

## Dataset Bindings

| Dataset id | Role | Path | Dataset hash | Row count |
|------------|------|------|--------------|-----------|
| btc-archive-formation | formation | `archive/btc/formation.parquet` | `PENDING_T16_FORMATION_DATASET_HASH` | 0 |
| btc-archive-evaluation-probe | evaluation_probe | `archive/btc/evaluation_probe.parquet` | `PENDING_T16_EVALUATION_PROBE_DATASET_HASH` | 0 |
