# Second Research Evidence Packet

Status: ARCHIVE_ONLY_NO_CLAIM
Schema version: first-research-evidence-packet/v1
Packet id: SECOND-RESEARCH-EVIDENCE-PACKET-001
Candidate id: SRC-001-STRUCTURE-RETEST-BOUNCE
Evidence packet hash: GENERATED_BY_T23_TEST_FIXTURE

## Hash Bindings

- dataset_hash: bound by `docs/research/second-packet/DATASET_MANIFEST.md`
- code_hash: bound by T22 archive evaluation harness fixture
- policy_hash: bound by T22 archive evaluation harness fixture
- parameter_hash: bound by T22 archive evaluation harness fixture
