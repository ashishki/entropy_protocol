...
**Filename:** `products/entropy-core/docs/audit/PROMPT_2_INVARIANTS.md`
**Pipeline Step:** Step 3 — Invariant Extraction
**Cycle:** 5 (Phase 1D-K Archive-Only Baseline Deep Review)
**Date:** 2026-05-06
**Output artifact:** `products/entropy-core/docs/audit/INVARIANTS.md`
...
3. `products/entropy-core/docs/audit/ARCH_MODEL.md` — **Step 2 required input**

**BLOCKED MODE CHECK:** If `products/entropy-core/docs/audit/ARCH_MODEL.md` does not exist or is labeled as incomplete, output:
```
...
4. `products/entropy-core/docs/core/PROTOCOL_SPEC.md` — especially Sections B, D, F, J, J1, J2
5. `products/entropy-core/docs/core/CHARTER.md` — especially Sections B, D, Kill Criteria Appendix, Phase exit criteria
6. `products/entropy-core/docs/core/GLOSSARY.md`
7. `products/entropy-core/docs/audit/REVIEW_REPORT.md` (current consolidated status)
...
Produce `products/entropy-core/docs/audit/INVARIANTS.md` — an exhaustive, structured list of every formal invariant that must hold during system operation. This becomes the machine-checkable reference for Steps 4 and 5.
...
Write the complete output to `products/entropy-core/docs/audit/INVARIANTS.md`. The file must:
