...
**Filename:** `products/entropy-core/docs/audit/PROMPT_3_DRIFT_GUARD.md`
**Pipeline Step:** Step 4 — Protocol Drift Guard
**Cycle:** 5 (Phase 1D-K Archive-Only Baseline Deep Review)
**Date:** 2026-05-06
**Output artifacts:** `products/entropy-core/docs/audit/DRIFT_ASSERTIONS.md` + `products/entropy-core/docs/audit/DRIFT_REPORT.md`
...
3. `products/entropy-core/docs/audit/INVARIANTS.md` — **Step 3 required input**

**BLOCKED MODE CHECK:** If `products/entropy-core/docs/audit/INVARIANTS.md` does not exist, output:
```
...
4. `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
5. `products/entropy-core/docs/core/CHARTER.md`
6. `products/entropy-core/docs/core/GLOSSARY.md`
7. `products/entropy-core/docs/core/EVOLUTION.md`
8. `products/entropy-core/docs/audience/ARCHITECT_BRIEF.md`
9. `products/entropy-core/docs/audience/TRADER_BRIEF.md`
10. `products/entropy-core/docs/audit/ARCH_MODEL.md`
11. `products/entropy-core/docs/audit/REVIEW_REPORT.md` (current consolidated status)
12. Prior `products/entropy-core/docs/audit/DRIFT_ASSERTIONS.md` and `products/entropy-core/docs/audit/DRIFT_REPORT.md` if present
...
1. `products/entropy-core/docs/audit/DRIFT_ASSERTIONS.md` — structured verdict list (machine-checkable)
2. `products/entropy-core/docs/audit/DRIFT_REPORT.md` — prose analysis (severity-ranked, human-readable)
...
- RDL constraints: compare PROTOCOL_SPEC.md Section E vs. products/entropy-core/docs/architecture/workflow_ai_development.md Section 6
...
- Does the "RDL outputs must never feed into RBE" constraint appear in products/entropy-core/docs/architecture/workflow_ai_development.md or any governance document, or only in PROTOCOL_SPEC.md?
