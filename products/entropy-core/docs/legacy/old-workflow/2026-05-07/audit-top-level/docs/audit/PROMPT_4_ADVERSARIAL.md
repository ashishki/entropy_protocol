...
**Filename:** `products/entropy-core/docs/audit/PROMPT_4_ADVERSARIAL.md`
**Pipeline Step:** Step 5 — Adversarial Review
**Cycle:** 5 (Phase 1D-K Archive-Only Baseline Deep Review)
**Date:** 2026-05-06
**Output artifact:** `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`
...
1. `products/entropy-core/docs/audit/PROMPT_0_META.md` — Cycle context, risk surfaces, hard constraints
...
4. `products/entropy-core/docs/audit/INVARIANTS.md` — **Step 3 required input**
5. `products/entropy-core/docs/audit/DRIFT_REPORT.md` — **Step 4 required input**
...
6. `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
7. `products/entropy-core/docs/core/CHARTER.md`
8. `products/entropy-core/docs/core/GLOSSARY.md`
9. `products/entropy-core/docs/core/EVOLUTION.md`
10. `products/entropy-core/docs/audience/ARCHITECT_BRIEF.md`
11. `products/entropy-core/docs/audit/REVIEW_REPORT.md` (current consolidated status)
12. Prior `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md` if present
...
Write the complete output to `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`. The file must:
