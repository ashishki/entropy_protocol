...
**Authority:** This document is subordinate to `products/entropy-core/docs/core/PROTOCOL_SPEC.md` and `products/entropy-core/docs/core/CHARTER.md`. Where any conflict exists, the core protocol governs.
...
- `products/entropy-core/docs/core/PROTOCOL_SPEC.md` Section E (Research Governance Interfaces) — RPM listed as governance component
- `products/entropy-core/docs/core/GLOSSARY.md` — definitions: Attention Signal (ATT), Derived Metric (DM), Session Comparison (SC), Research Portfolio Monitor (RPM)
- `products/entropy-core/docs/governance/research_firewall.md` — Research Firewall (RPM is downstream of firewall; firewall governs admissibility; RPM displays state)
- `products/entropy-core/docs/governance/hypothesis_families.md` — Hypothesis Families (ATT conditions reference family names; family definitions are authoritative here)
- `products/entropy-core/docs/governance/experiment_readiness_gate.md` — Experiment Readiness Gate (RPM displays trial counts; gate governs admissibility)
- `products/entropy-core/docs/architecture/system_architecture.md` Section 5 — Governance Layer (RPM listed as component)
