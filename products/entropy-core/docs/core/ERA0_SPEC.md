...
and the approved content is merged into `products/entropy-core/docs/core/PROTOCOL_SPEC.md`, `products/entropy-core/docs/core/GLOSSARY.md`,
`products/entropy-core/docs/core/CHARTER.md`, and `products/entropy-core/docs/core/EVOLUTION.md`.
...
|---|---|---|
| `products/entropy-core/docs/core/PROTOCOL_SPEC.md` | §D Regime Signal Governance | Add P4-v1 algorithm block |
| `products/entropy-core/docs/core/PROTOCOL_SPEC.md` | §F Phase 1 exit criteria | Replace "haircut < 0.05" with "passes = True (DSR > 0.95)" |
| `products/entropy-core/docs/core/GLOSSARY.md` | Deflated Sharpe (Harvey-Liu) | Replace placeholder with HL-HB-v1 full formula |
| `products/entropy-core/docs/core/GLOSSARY.md` | Net Sharpe CI reference | Replace placeholder with CI-SR-ACF-v1 full formula |
| `products/entropy-core/docs/core/CHARTER.md` | Phase 1 metrics table | Replace "haircut < 0.05" row; add DSR > 0.95 |
| `products/entropy-core/docs/core/CHARTER.md` | Any ±0.15–0.20 CI language | Remove or replace with correct ±0.89 reference |
| `products/entropy-core/docs/core/EVOLUTION.md` | Closed decisions summary | Add decisions 12 (P4-v1), 13 (HL-HB-v1), 14 (CI-SR-ACF-v1) |
