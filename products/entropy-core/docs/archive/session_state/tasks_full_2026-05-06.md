...
Artifacts:
  - products/entropy-core/docs/audit/archive/phase0/PHASE0_EXIT_GAP_REGISTER.md
...
Artifacts:
  - products/entropy-core/docs/audit/archive/p0_5/FORMULA_EVIDENCE_DEBT.md
...
Artifacts:
  - products/entropy-core/docs/audit/archive/p0_5/SHARPE_CI_REVIEW.md
  - products/entropy-core/docs/audit/archive/p0_5/HARVEY_LIU_REVIEW.md
  - products/entropy-core/docs/DECISION_LOG.md D-022
...
Artifacts:
  - products/entropy-core/docs/audit/archive/p0_5/PURGE_EMBARGO_DECISION.md
  - products/entropy-core/docs/DECISION_LOG.md D-023
...
Artifacts:
  - products/entropy-core/docs/audit/archive/p0_5/P4_GATE_DECISION.md
  - products/entropy-core/docs/DECISION_LOG.md D-024
...
Artifacts:
  - products/entropy-core/docs/audit/archive/p0_5/SIMBROKER_CALIBRATION_PLAN.md
...
Artifacts:
  - products/entropy-core/docs/audit/archive/p0_5/DATA_STABILITY_PLAN.md
...
Artifacts:
  - products/entropy-core/docs/audit/archive/phase0/PHASE0_GATE_PACKET.md
  - products/entropy-core/docs/DECISION_LOG.md future gate decision
...
Context-Refs:
  - products/entropy-core/docs/core/PROTOCOL_SPEC.md §Deterministic P4 Protocol
  - products/entropy-core/docs/audit/archive/p0_5/P4_GATE_DECISION.md
  - products/entropy-core/docs/audit/archive/phase0/PHASE0_GATE_PACKET.md
...
Objective: |
  ...
  `products/entropy-core/docs/audit/archive/p0_5/SIMBROKER_CALIBRATION_PLAN.md`; no provider activation.
...
Objective: |
  ...
  `products/entropy-core/docs/audit/archive/p0_5/DATA_STABILITY_PLAN.md`; no provider activation.
...
Files:
  - products/entropy-core/docs/audit/archive/p0_5/EVIDENCE_COLLECTION_AUTHORIZATION.md
...
Objective: |
  Human owner reviews `products/entropy-core/docs/audit/archive/p0_5/EVIDENCE_COLLECTION_AUTHORIZATION.md` and
...
Files:
  - products/entropy-core/docs/audit/archive/p0_5/EVIDENCE_COLLECTION_AUTHORIZATION.md
  - products/entropy-core/docs/audit/archive/p0_5/EVIDENCE_SOURCE_SELECTION.md
...
Files:
  ...
  - products/entropy-core/docs/audit/archive/p0_6/CRYPTO_UNIVERSE_SNAPSHOT.md
  - products/entropy-core/docs/audit/archive/p0_6/SOURCE_MANIFEST_BOOTSTRAP.md
...
Files:
  ...
  - products/entropy-core/docs/audit/archive/p0_6/BINANCE_P4_CANARY.md
...
Files:
  ...
  - products/entropy-core/docs/audit/archive/p4/P4_COVERAGE_SCALE_PLAN.md
  - products/entropy-core/docs/audit/archive/p4/P4_COVERAGE_SCALE_MANIFEST.json
...
Files:
  ...
  - products/entropy-core/docs/audit/archive/p4/P4_FIRST_BATCH_COLLECTION.md
...
Files:
  ...
  - products/entropy-core/docs/audit/archive/p4/P4_FIRST_BATCH_CONVERSION.md
...
Files:
  - entropy/evidence/p4_scale_plan.py
  - tests/unit/test_p4_scale_plan.py
  - products/entropy-core/docs/audit/archive/p4/P4_BATCH_002_COLLECTION.md
...
Files:
  - entropy/evidence/p4_batch_conversion.py
  - tests/unit/test_p4_batch_conversion.py
  - products/entropy-core/docs/audit/archive/p4/P4_BTCUSDT_FULL_WINDOW_CONVERSION.md
...
Files:
  - products/entropy-core/docs/audit/archive/p4/P4_COVERAGE_WINDOW_STRATEGY_DECISION.md
  - products/entropy-core/docs/audit/archive/phase0/PHASE0_GATE_PACKET.md
...
Files:
  ...
  - products/entropy-core/docs/audit/archive/p4/P4_EXTENDED_HISTORY_ELIGIBILITY_PROBE.md
...
Files:
  ...
  - entropy/evidence/__init__.py
  - tests/unit/test_crypto_universe.py
  - products/entropy-core/docs/audit/archive/p4/P4_UNIVERSE_REVISION_DECISION.md
  - products/entropy-core/docs/audit/archive/p4/P4_REVISED_CRYPTO_UNIVERSE_SNAPSHOT.md
...
Files:
  ...
  - entropy/evidence/__init__.py
  - tests/unit/test_p4_scale_plan.py
  - products/entropy-core/docs/audit/archive/p4/P4_REVISED_SCALE_PLAN_DECISION.md
  - products/entropy-core/docs/audit/archive/p4/P4_REVISED_COVERAGE_SCALE_PLAN.md
  - products/entropy-core/docs/audit/archive/p4/P4_REVISED_COVERAGE_SCALE_MANIFEST.json
...
Files:
  - products/entropy-core/docs/audit/archive/p4/P4_REVISED_BATCH_001_COLLECTION.md
...
Files:
  - products/entropy-core/docs/audit/archive/p4/P4_REVISED_BATCH_001_CONVERSION.md
...
Files:
  - products/entropy-core/docs/audit/archive/p4/P4_REVISED_BATCH_002_COLLECTION.md
...
Files:
  - products/entropy-core/docs/audit/archive/p4/P4_REVISED_FIRST15_COVERAGE_PACKET.md
  - artifacts/evidence/p4_binance_scale/revised_v2/batches/batch_001/
    through batch_054/
...
Files:
  - products/entropy-core/docs/audit/archive/p4/P4_COVERAGE_PACKET_REVIEW.md
  - artifacts/evidence/p4_binance_scale/revised_v2/coverage/first_15_assets_2020_2025/
...
Files:
  ...
  - products/entropy-core/docs/audit/archive/simbroker/SIMBROKER_CALIBRATION_BOOTSTRAP.md
...
Files:
  ...
  - entropy/simbroker/__init__.py
  - tests/unit/test_simbroker.py
  - products/entropy-core/docs/audit/archive/simbroker/SIMBROKER_CALIBRATION_CANDIDATE_ROW_PLAN.md
...
Files:
  - products/entropy-core/docs/audit/archive/simbroker/SIMBROKER_CALIBRATION_DRY_RUN.md
...
Files:
  - products/entropy-core/docs/audit/archive/data_stability/DATA_STABILITY_BOOTSTRAP.md
...
Files:
  ...
  - products/entropy-core/docs/audit/archive/data_stability/DATA_STABILITY_SIMULATION.md
  - products/entropy-core/docs/audit/archive/data_stability/DAILY_STABILITY_APPEND_PROCEDURE.md
  - products/entropy-core/docs/audit/archive/simbroker/SIMBROKER_AGENT_ASSISTED_VERIFICATION_DECISION.md
...
Files:
  - products/entropy-core/docs/audit/archive/simbroker/SIMBROKER_AGENT_ASSISTED_VERIFICATION_DECISION.md
  - products/entropy-core/docs/audit/archive/simbroker/SIMBROKER_AGENT_VERIFIED_CALIBRATION_PACKET.md
...
Files:
  ...
  - products/entropy-core/docs/audit/archive/data_stability/DATA_STABILITY_LIVE_APPEND_TOOLING.md
...
Files:
  ...
  - products/entropy-core/docs/audit/archive/p0_7/REGISTERED_LEAKAGE_GATE_PACKET.md
...
Files:
  - products/entropy-core/docs/audit/archive/p0_7/STATISTICAL_REPORT_GATE_PACKET.md
...
Files:
  - products/entropy-core/docs/audit/archive/phase0/PHASE0_GATE_PACKET.md
  - products/entropy-core/docs/audit/archive/phase0/PHASE0_FINAL_SYNC.md
...
Files:
  ...
  - products/entropy-core/docs/audit/archive/p0_7/ARCHIVE_ONLY_EVIDENCE_MODE_DECISION.md
  - products/entropy-core/docs/audit/archive/data_stability/DATA_STABILITY_ARCHIVE_PACKET.md
...
Files:
  - products/entropy-core/docs/audit/archive/p0_7/ARCHIVE_ONLY_CONTINUATION_DECISION.md
  - products/entropy-core/docs/DECISION_LOG.md
...
Files:
  - products/entropy-core/docs/audit/PHASE1A_ARCHIVE_ENTRY_CONTRACT.md
...
Files:
  ...
  - products/entropy-core/docs/audit/PHASE1A_ARCHIVE_FREEZE_PACKET.md
...
Files:
  ...
  - products/entropy-core/docs/audit/PHASE1A_REGISTRATION_BOUNDARY_PACKET.md
...
Files:
  ...
  - products/entropy-core/docs/audit/PHASE1A_BASELINE_REGISTRATION_PACKET.md
...
Files:
  - products/entropy-core/docs/audit/PHASE1A_FIX_CLOSURE_REVIEW.md
  - products/entropy-core/docs/tasks.md
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/EVIDENCE_INDEX.md
  - products/entropy-core/docs/audit/AUDIT_INDEX.md
...
Files:
  - products/entropy-core/docs/audit/PHASE1A_DEVELOPMENT_STRATEGY.md
  - products/entropy-core/docs/tasks.md
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/EVIDENCE_INDEX.md
  - products/entropy-core/docs/audit/AUDIT_INDEX.md
...
Files:
  - products/entropy-core/docs/audit/PHASE1A_WORKLOAD_BENCHMARK_CONTRACT.md
  - products/entropy-core/docs/tasks.md
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/EVIDENCE_INDEX.md
  - products/entropy-core/docs/audit/AUDIT_INDEX.md
...
Files:
  ...
  - products/entropy-core/docs/audit/PHASE1A_BASELINE_SCAFFOLD_PACKET.md
  - products/entropy-core/docs/tasks.md
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/EVIDENCE_INDEX.md
  - products/entropy-core/docs/audit/AUDIT_INDEX.md
...
Files:
  ...
  - products/entropy-core/docs/audit/PHASE1A_SCAFFOLD_PERFORMANCE_PROBE_PACKET.md
  - products/entropy-core/docs/tasks.md
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/EVIDENCE_INDEX.md
  - products/entropy-core/docs/audit/AUDIT_INDEX.md
...
Files:
  - products/entropy-core/docs/audit/PHASE1A_SCAFFOLD_CLOSURE_REVIEW.md
  - products/entropy-core/docs/tasks.md
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/EVIDENCE_INDEX.md
  - products/entropy-core/docs/audit/AUDIT_INDEX.md
...
Files:
  ...
  - products/entropy-core/docs/audit/PHASE1A_AUDIT_PROMPT_REFRESH_PACKET.md
  - products/entropy-core/docs/tasks.md
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/EVIDENCE_INDEX.md
  - products/entropy-core/docs/audit/AUDIT_INDEX.md
...
Context-Refs:
  - products/entropy-core/docs/audit/POST_PHASE1A_STRATEGY_REVIEW.md
  - products/entropy-core/docs/audit/POST_PHASE1A_NEXT_STAGE_PLAN.md
  - products/entropy-core/docs/audit/REVIEW_REPORT.md F-C3-007
...
Result:
  ...
  - New finding F-C4-001 records P2 documentation drift: `ARCHITECTURE.md` and
    `products/entropy-core/docs/spec.md` current-state prose still says Phase 0.5 while the active
...
Acceptance-Criteria:
  - id: AC-1
    ...
    test: "manual review"
  - id: AC-2
    description: "`products/entropy-core/docs/spec.md` current-state prose acknowledges post-Phase-1A audit readiness without authorizing Phase 1 evaluation/trading."
    test: "manual review"
  - id: AC-3
...
Files:
  - products/entropy-core/docs/audit/POST_PHASE1A_OPERATIONS_PLAN.md
  - products/entropy-core/docs/tasks.md
  - products/entropy-core/docs/CODEX_PROMPT.md
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/EVIDENCE_INDEX.md
...
### [x] P1D-001: Long-Only Implementation Contract
...
Files:
  - entropy/baseline/implementation.py
  - entropy/baseline/__init__.py
  - tests/unit/test_phase1d_implementation_contract.py
  - products/entropy-core/docs/tasks.md
  - products/entropy-core/docs/CODEX_PROMPT.md
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/EVIDENCE_INDEX.md
...
Acceptance-Criteria:
  ...
  - id: AC-4
    ...
    test: "tests/unit/test_phase1d_implementation_contract.py"

Result:
  - Added `PHASE1D-LONG-ONLY-IMPLEMENTATION-CONTRACT-v1`.
  - Contract binds to ready Phase 1C preflight metadata and the Phase 1B
    baseline surface.
  - Allowed work is formation-only contract checking and deterministic
    transform-family declaration.
  - Validation/holdout reads, evaluation, portfolio, performance metrics,
    live/broker requests, runtime escalation, forbidden output columns, and
    forbidden labels are denied with stable reason codes.
  - Replacing schema-only stubs still requires the separate
    `phase1e_bounded_implementation_approval` gate.
  - Light review result: PASS.
  - Full verification baseline is `248 passed, 20 skipped`.
  - Spec Owner selected D-K continuation with light review after each phase and
    deep review after the full D-K block.
...
### [x] P1D-ROADMAP-001: D-K Sequential Roadmap Acceptance
...
### [x] P1E-HUMAN-001: Baseline Implementation Approval
...
Result:
  - Spec Owner approved continuing D-K and opening P1E bounded implementation
    under the P1D contract.
  - Review cadence is light review after each phase, with deep review after the
    full D-K block.

### [x] P1E-001: Bounded Long-Only Baseline Logic
...
Files:
  - entropy/baseline/bounded.py
  - entropy/baseline/__init__.py
  - tests/unit/test_phase1e_bounded_baseline.py
  - products/entropy-core/docs/tasks.md
  - products/entropy-core/docs/CODEX_PROMPT.md
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/EVIDENCE_INDEX.md
...
Result:
  - Added `PHASE1E-BOUNDED-LONG-ONLY-BASELINE-LOGIC-v1`.
  - Bounded baseline outputs formation-only observations for all six registered
    skill families.
  - Outputs preserve no-claim labels and exclude forbidden alpha/score/rank/
    weight/position/PnL/return/performance/gate fields.
  - Prefix-stability test proves future rows do not alter prior observations.
  - Validation and holdout remain blocked by the formation adapter.
  - Light review result: PASS.
  - Focused verification baseline is `39 passed`.
  - Next task: P1F-001 Baseline Code And Policy Hash Binding.
...
### [x] P1F-001: Baseline Code And Policy Hash Binding
...
Result:
  - Added `PHASE1F-BASELINE-CODE-POLICY-HASH-BINDING-v1`.
  - Binding records deterministic code, policy, input contract, dataset,
    surface schema, implementation contract, and output hashes.
  - Binding requires outputs for all registered skill families.
  - No registry write, evaluation, gate claim, or phase-gate evidence is
    emitted.

### [x] P1F-002: Trial Registry Pre-Registration Surface
...
Result:
  - Added `PHASE1F-TRIAL-PREREGISTRATION-SURFACE-v1`.
  - Surface builds a complete `TrialSpec` with dataset/code/policy hashes and a
    deterministic parameter lock.
  - Registry write remains disabled; this phase prepares payloads only.
  - Light review result: PASS.
  - Focused verification baseline is `56 passed`.
  - Next task: P1G-001 Evaluation Configuration Contract.
...
### [x] P1G-001: Evaluation Configuration Contract
...
Files:
  - entropy/baseline/evaluation.py
  - entropy/baseline/__init__.py
  - tests/unit/test_phase1g_evaluation_config.py
  - products/entropy-core/docs/tasks.md
  - products/entropy-core/docs/CODEX_PROMPT.md
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/EVIDENCE_INDEX.md
...
Result:
  - Added `PHASE1G-EVALUATION-CONFIGURATION-CONTRACT-v1`.
  - Config records walk-forward windows, leakage checks, SimBroker version,
    statistical report fields, family accounting, split policy, and required
    human gates.
  - Guard denies holdout, live/broker, performance conclusion, phase-gate,
    production, and capital-ready requests.
  - Evaluation execution requires `phase1g_evaluation_run_approval`.
  - Light review result: PASS.
  - Focused verification baseline is `55 passed`.

### [x] P1G-HUMAN-001: Evaluation Run Approval
...
Result:
  - Spec Owner approved continuing D-K and opening P1H first governed
    archive-only evaluation.
  - Holdout access, production labels, and capital-ready claims remain blocked.
  - Next task: P1H-001 First Archive-Only Governed Evaluation Run.
...
### [x] P1H-001: First Archive-Only Governed Evaluation Run
...
Files:
  - entropy/baseline/governed.py
  - entropy/baseline/__init__.py
  - tests/unit/test_phase1h_governed_evaluation.py

Result:
  - Added `PHASE1H-FIRST-ARCHIVE-GOVERNED-EVALUATION-v1`.
  - Run surface calls the walk-forward runner with approved Phase 1G metadata.
  - Emits deterministic `RunRecord` metadata and leakage PASS status.
  - No holdout, performance conclusion, phase-gate evidence, production label,
    or capital-ready label is emitted.
  - Light review result: PASS.
...
### [x] P1I-001: Evaluation Report Assembly
...
Result:
  - Added `PHASE1I-EVALUATION-REPORT-PACKET-v1`.
  - Report packet assembles config hash, parameter-lock hash, run record hashes,
    leakage status, statistical report field inventory, and no-claim labels.
  - Report remains not phase-gate evidence and carries no holdout, production,
    or capital-ready claim.

### [x] P1I-002: Deep Protocol Review After Evaluation
...
Result:
  - Superseded by Spec Owner instruction on 2026-05-06: continue through D-K
    with light review after each phase, then run one full deep review over the
    completed D-K block.
...
### [x] P1J-HUMAN-001: Research Decision Review
...
Result:
  - Added `PHASE1J-RESEARCH-DECISION-v1`.
  - Decision is `archive_only_research_packet_complete_no_holdout_request`.
  - No production or capital-ready label is emitted.

### [x] P1J-HUMAN-002: Holdout Gate Decision
...
Result:
  ...
  - Reason code: `NO_PERFORMANCE_CONCLUSION_FOR_HOLDOUT`.
  - P1K closure proceeds as no-holdout archive-only closure.
...
### [x] P1K-001: Holdout/Final Research Audit Packet
...
Files:
  - entropy/baseline/decision.py
  - entropy/baseline/__init__.py
  - tests/unit/test_phase1i_j_k_packets.py

Result:
  - Added `PHASE1K-ARCHIVE-ONLY-CLOSURE-PACKET-v1`.
  - Packet records no-holdout closure because the holdout gate was not opened.
  - Packet marks full D-K deep review as the next required workflow step.

### [x] P1K-HUMAN-001: Research Phase Closure Decision
...
Result:
  - Archive-only D-K block completed and triggered the required full deep
    review.
  - Full verification baseline is `275 passed, 20 skipped`.
  - Required full D-K deep review is recorded in DK-REVIEW-001.

### [x] DK-REVIEW-001: Full D-K Deep Review And Fix Closure

Objective: |
  Run the full audit prompt sequence over the completed D-K block, consolidate
  findings, and apply required fixes without opening holdout, production,
  capital-ready, live-feed, broker, Growth/RDL/RBE, or performance-claim
  surfaces.
...
Result:
  - Deep review ran through prompts 0-5 and refreshed the canonical audit
    outputs.
  - F-DK-001 fixed: Phase 1F code hash normalizes repository-local source paths
    before hashing, so absolute and relative references to the same source file
    bind identically.
  - F-DK-002 fixed: Phase 1I report payload records deterministic per-stat-field
    status `not_computed_no_performance_conclusion`.
  - F-DK-003 fixed: active audit prompt headers and current context identify
    Cycle 5 D-K deep review.
  - Verification baseline is `277 passed, 20 skipped`; ruff, pyright, and
  ...
  - Next step: Spec Owner next decision after D-K fix closure.
...
Context-Refs:
  - products/entropy-core/docs/ARCHITECTURE.md §File Layout
  - products/entropy-core/docs/ARCHITECTURE.md §Tech Stack
...
Context-Refs:
  - products/entropy-core/docs/ARCHITECTURE.md §Runtime Contract
...
Context-Refs:
  - products/entropy-core/docs/spec.md §Data Pipeline
...
Context-Refs:
  - products/entropy-core/docs/spec.md §Trial Registry
  - products/entropy-core/docs/ARCHITECTURE.md §Human Approval Boundaries
...
Context-Refs:
  - products/entropy-core/docs/spec.md §P&L Attribution
  - products/entropy-core/docs/core/PROTOCOL_SPEC.md §NN-2
...
Context-Refs:
  - products/entropy-core/docs/ARCHITECTURE.md §Component Table
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §Registry Append-Only
...
Context-Refs:
  - products/entropy-core/docs/DECISION_LOG.md §D-008
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §Hash Determinism
...
Context-Refs:
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §Registry Append-Only
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §SQL Safety
...
Context-Refs:
  - products/entropy-core/docs/spec.md §Data Pipeline
  - products/entropy-core/docs/ARCHITECTURE.md §External Integrations
...
Context-Refs:
  - products/entropy-core/docs/spec.md §SimBroker
  - products/entropy-core/docs/core/PROTOCOL_SPEC.md §Cost Model Components
...
Context-Refs:
  - products/entropy-core/docs/spec.md §SimBroker
  - products/entropy-core/docs/EVIDENCE_INDEX.md §Heavy Task Evidence
...
Context-Refs:
  - products/entropy-core/docs/spec.md §SimBroker
  - products/entropy-core/docs/EVIDENCE_INDEX.md §Statistical Formula Stubs
...
Context-Refs:
  - products/entropy-core/docs/EVIDENCE_INDEX.md §Statistical Formula Stubs (purge/embargo formula)
  - products/entropy-core/docs/IMPLEMENTATION_JOURNAL.md §2026-05-01
...
Context-Refs:
  - products/entropy-core/docs/spec.md §Walk-Forward Harness
  - products/entropy-core/docs/EVIDENCE_INDEX.md §Heavy Task Evidence
...
Context-Refs:
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §Run Reproducibility
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §OOS Separation Enforcement
...
Governance-Disposition: D-017 (`products/entropy-core/docs/audit/archive/dispositions/T21_FORMULA_GOVERNANCE_DISPOSITION.md`)
...
Context-Refs:
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §Net Sharpe Stream Boundary
  - products/entropy-core/docs/core/PROTOCOL_SPEC.md §NN-2
  - products/entropy-core/docs/EVIDENCE_INDEX.md §Heavy Task Evidence
...
Type:       none
Depends-On: T05, T07
Governance-Disposition: D-018 (`products/entropy-core/docs/audit/archive/dispositions/T22_GOVERNANCE_DISPOSITION.md`)
...
Context-Refs:
  - products/entropy-core/docs/core/PROTOCOL_SPEC.md §D Regime Signal Governance
  - products/entropy-core/docs/EVIDENCE_INDEX.md §Heavy Task Evidence
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §Phase Gate Human Approval
...
Type:       none
Depends-On: T06
Governance-Disposition: D-019 (`products/entropy-core/docs/audit/archive/dispositions/T23_FORMULA_GOVERNANCE_DISPOSITION.md`)
...
Context-Refs:
  - products/entropy-core/docs/EVIDENCE_INDEX.md §Statistical Formula Stubs
  - products/entropy-core/docs/core/PROTOCOL_SPEC.md §Harvey-Liu Haircut Method
...
Governance-Disposition: D-020 (`products/entropy-core/docs/audit/archive/dispositions/T24_EXIT_ARTIFACTS_DISPOSITION.md`)
...
Context-Refs:
  - products/entropy-core/docs/spec.md §Phase Gate Evidence
  - products/entropy-core/docs/EVIDENCE_INDEX.md §Phase Gate Evidence
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §Phase Gate Human Approval
...
Objective: |
  Record a formal written disposition in products/entropy-core/docs/DECISION_LOG.md that resolves the
...
Acceptance-Criteria:
  - id: AC-1
    description: "products/entropy-core/docs/DECISION_LOG.md contains a new entry with date 2026-05-03 or later referencing ARCH-3 and explicitly choosing disposition (a) or (b) with rationale."
    test: "grep -i 'ARCH-3' products/entropy-core/docs/DECISION_LOG.md returns non-empty"
  - id: AC-2
    description: "products/entropy-core/docs/CODEX_PROMPT.md §Open Findings records ARCH-3 with disposition status (open pending Spec Owner sign-off, or closed with reference to DECISION_LOG entry)."
    test: "grep 'ARCH-3' products/entropy-core/docs/CODEX_PROMPT.md returns non-empty"
...
Context-Refs:
  - products/entropy-core/docs/audit/REVIEW_REPORT.md §P1 Issues §P1-1
  - products/entropy-core/docs/audit/archive/legacy/ARCH_REPORT.md §ARCH-3
  - products/entropy-core/docs/audit/META_ANALYSIS.md §MG-06
...
Progress:    Completed by D-016 and `products/entropy-core/docs/audit/archive/dispositions/D010_FOCUSED_AUDIT_F1_F2_F4_F5.md`. F-1/F-2/F-4/F-5 are closed for T15 entry. F-30/F-31 remain In Progress future real-evidence gates and do not block T15.
...
Acceptance-Criteria:
  - id: AC-1
    description: "products/entropy-core/docs/DECISION_LOG.md contains D-013 and D-015, documenting both the no-waiver decision and the narrowed T15 blocker scope."
    test: "grep 'D-013' products/entropy-core/docs/DECISION_LOG.md && grep 'D-015' products/entropy-core/docs/DECISION_LOG.md"
  - id: AC-2
  ...
  - id: AC-4
    description: "products/entropy-core/docs/CODEX_PROMPT.md names T15 as next task only after AC-2 passes for F-1/F-2/F-4/F-5 and AC-3 records F-30/F-31 future-gate status."
    test: "manual review of products/entropy-core/docs/CODEX_PROMPT.md and cited audit evidence"

Files:
  - products/entropy-core/docs/DECISION_LOG.md
  - products/entropy-core/docs/CODEX_PROMPT.md
  - products/entropy-core/docs/audit_task_registry.md
  - products/entropy-core/docs/audit/REVIEW_REPORT.md or successor review artifact
  - products/entropy-core/docs/core/PROTOCOL_SPEC.md
  - products/entropy-core/docs/core/CHARTER.md
  - products/entropy-core/docs/core/GLOSSARY.md
  - products/entropy-core/docs/audit/archive/dispositions/D010_FOCUSED_AUDIT_F1_F2_F4_F5.md

Context-Refs:
  - products/entropy-core/docs/DECISION_LOG.md D-010, D-013, D-014, D-015, D-016
  - products/entropy-core/docs/audit/archive/phase_reviews/PHASE5_REVIEW.md §Gate Warning
  - products/entropy-core/docs/audit/archive/dispositions/D010_FOCUSED_AUDIT_F1_F2_F4_F5.md
  - products/entropy-core/docs/audit_task_registry.md §P0 Findings
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §Review Cycle Integrity
...
Objective: |
  ...
  products/entropy-core/docs/ARCHITECTURE.md §Observability and products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §OBS-3.
...
Context-Refs:
  - products/entropy-core/docs/ARCHITECTURE.md §Observability
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §OBS-3
...
Context-Refs:
  - products/entropy-core/docs/audit/REVIEW_REPORT.md §P2 Issues (CODE-1, CODE-2)
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §Shared Tracing Module
...
Context-Refs:
  - products/entropy-core/docs/audit/REVIEW_REPORT.md §P2 Issues (CODE-4)
  - products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §SQL Safety
