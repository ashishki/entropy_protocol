...
**Symptom:** `products/entropy-core/docs/CODEX_PROMPT.md` records Phase: 1 with T01–T03 complete and T04 as next task. Cycle 1 REVIEW_REPORT.md states "Phase 0 exit certification remains blocked" and "Phase 1 entry and later phases remain blocked until all P0 are remediated and re-verified by pipeline rerun." No document records a formal scope-separation decision or Spec Owner waiver.

**Evidence:** `products/entropy-core/docs/CODEX_PROMPT.md:5` (Phase: 1); `products/entropy-core/docs/audit/META_ANALYSIS.md §MG-06`; `products/entropy-core/docs/audit/ARCH_REPORT.md §ARCH-3`; Cycle 1 REVIEW_REPORT.md P0 findings list (F-1, F-2, F-4, F-5, F-30, F-31 Inherited-Open or Partial-Mitigation).

**Root Cause:** `products/entropy-core/docs/audit/PHASE1_AUDIT.md` (2026-05-01) passed a pre-implementation audit of the engineering documentation layer only (ARCHITECTURE.md, spec.md, tasks.md, CODEX_PROMPT.md, IMPLEMENTATION_CONTRACT.md, ci.yml). This is a distinct audit scope from the protocol-specification audit. No document records a formal scope separation decision or Spec Owner waiver permitting Phase 1 engineering to proceed while protocol-level P0 findings remain open.
...
| CODE-3 / ARCH-1 | `entropy health` CLI command absent; OBS-3 contract unmet; no task currently owns implementation | `entropy/cli.py:1-27`, `products/entropy-core/docs/ARCHITECTURE.md §Observability`, `products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md §OBS-3` | Open — task T-OBS-1 added |
...
| CODE-5 | `products/entropy-core/docs/CODEX_PROMPT.md §Open Findings` stated "none" despite open ARCH-3 (P1) and ARCH-1 (P2) | `products/entropy-core/docs/CODEX_PROMPT.md:71` | Fixed — patched this cycle |
| ARCH-2 | `products/entropy-core/docs/adr/` directory absent; ADR governance path declared but not bootstrapped | `products/entropy-core/docs/adr/` (does not exist) | Open |
| ARCH-4 | `products/entropy-core/docs/ARCHITECTURE.md` Component Table omits RDL, Research Firewall, ERG, RPM, Governor; enforcement mapping missing | `products/entropy-core/docs/ARCHITECTURE.md:113-128` | Open |
| ARCH-5 / MG-09 | `products/entropy-core/docs/core/ERA0_SPEC.md` authority status undefined; not referenced in any canonical document | `products/entropy-core/docs/core/ERA0_SPEC.md` | Open — Spec Owner disposition required |
| ARCH-6 / MS-04 / MG-10 | `products/entropy-core/docs/README.md` states "Phase 0 (active)"; `products/entropy-core/docs/ARCHITECTURE.md` and `products/entropy-core/docs/spec.md` absent from Documentation Map | `products/entropy-core/docs/README.md` | Open |
| MG-07 | CHARTER.md v5.0→v5.1 delta not self-documented; no visible changelog entry | `products/entropy-core/docs/core/CHARTER.md` | Open |
| MG-08 | PROTOCOL_SPEC v1.5/v1.6 additions (RPM, Research Firewall, ERG, HF) not audited against frozen non-negotiables or kill criteria | `products/entropy-core/docs/core/PROTOCOL_SPEC.md` | Open — requires pipeline Steps 2–5 rerun |
| MS-02 | AI_ENGINEERING_FRAMEWORK.md references PROTOCOL_SPEC v1.1; current spec is v1.6 (3 versions behind) | `products/entropy-core/docs/architecture/AI_ENGINEERING_FRAMEWORK.md` | Open |
| MS-05 | PROMPT_0_META.md cycle context stale (Phase 0 pre-development state) | `products/entropy-core/docs/audit/PROMPT_0_META.md` | Open |
| MV-03 | K3 trigger "2 consecutive months" absent from kill criteria appendix | `products/entropy-core/docs/core/PROTOCOL_SPEC.md`, `products/entropy-core/docs/core/CHARTER.md` | Open — carries forward from F-29 Partial-Mitigation |
| MG-02 | EVOLUTION.md missing rationale for Growth Layer, RDL, RPM, and governance layer additions | `products/entropy-core/docs/core/EVOLUTION.md` | Open — extended this cycle |
| MG-03 | Claimed superseded files (`strategic_charter_v5.md`, `entropy_protocol_master_spec_v1.md`) not found in archive | `products/entropy-core/docs/archive/` | Open — carried forward |
| MG-04 | workflow_ai_development.md version header (1.0) vs. changelog (1.1) mismatch | `products/entropy-core/docs/architecture/workflow_ai_development.md` | Open — carried forward |
| MS-01 | ARCHITECT_BRIEF.md footer references superseded filenames | `products/entropy-core/docs/audience/ARCHITECT_BRIEF.md` | Open — carried forward |
| MV-01 | "NNN-5" typo in CHARTER.md (should be "NN-5") | `products/entropy-core/docs/core/CHARTER.md` | Open — carried forward |
| MV-05 | "Regime" definition incomplete in GLOSSARY.md and CHARTER.md; fragment exclusion rule absent | `products/entropy-core/docs/core/GLOSSARY.md`, `products/entropy-core/docs/core/CHARTER.md` | Open — carried forward |
| MV-06 | GLOSSARY.md coverage gaps: 13 original missing terms + new v1.5/v1.6 terms unconfirmed | `products/entropy-core/docs/core/GLOSSARY.md` | Open — GLOSSARY at v1.2; completeness unconfirmed |
...
ARCH-3 (P1-1 above) requires a formal Spec Owner disposition in `products/entropy-core/docs/DECISION_LOG.md` before T04 begins. T04 (Market Data Models) does not itself encode a protocol formula and could proceed under a scope-separation disposition — but that disposition has not been recorded. The Spec Owner must write the disposition entry before the orchestrator hands T04 to Codex.
...
*Output: `products/entropy-core/docs/audit/REVIEW_REPORT.md`*
*Archive instruction: move to `products/entropy-core/docs/audit/archive/PHASE1_REVIEW.md` before Cycle 3*
