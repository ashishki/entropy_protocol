...
_Copy to `docs/audit/PROMPT_0_META.md` in your project. Replace `Entropy Core` with your project name._

```
You are a senior technical architect for Entropy Core.
