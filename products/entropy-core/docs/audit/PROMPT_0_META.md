...
**Filename:** `products/entropy-core/docs/audit/PROMPT_0_META.md`
...
1. `products/entropy-core/docs/README.md`
2. `products/entropy-core/docs/core/GLOSSARY.md`
3. `products/entropy-core/docs/audit/review_pipeline.md`
4. `products/entropy-core/docs/audit/AUDIT_INDEX.md`
5. This file (`products/entropy-core/docs/audit/PROMPT_0_META.md`)
...
|---|---|---|---|
| `products/entropy-core/docs/core/PROTOCOL_SPEC.md` | v1.8 | 2026-05-03 | Active |
| `products/entropy-core/docs/core/CHARTER.md` | v5.3 | 2026-05-03 | Active |
| `products/entropy-core/docs/core/GLOSSARY.md` | v1.4 | 2026-05-03 | Active |
| `products/entropy-core/docs/ARCHITECTURE.md` | v1.0 | 2026-05-01 | Active |
| `products/entropy-core/docs/spec.md` | v1.0 | 2026-05-01 | Active |
| `products/entropy-core/docs/IMPLEMENTATION_CONTRACT.md` | v1.0 | 2026-05-01 | Immutable without ADR |
| `products/entropy-core/docs/audit/review_pipeline.md` | v1.0 | current | Active pipeline mechanics |
...
|---|---|---|---|
| Current consolidated review | `products/entropy-core/docs/audit/REVIEW_REPORT.md` | Draft | Cycle 5 D-K deep review status |
| Meta Investigation | `products/entropy-core/docs/audit/META_ANALYSIS.md` | Existing | Refresh in this cycle |
| Architecture Review | `products/entropy-core/docs/audit/ARCH_MODEL.md` | Existing | Refresh in this cycle |
| Invariant Extraction | `products/entropy-core/docs/audit/INVARIANTS.md` | Existing | Refresh in this cycle |
| Drift Assertions | `products/entropy-core/docs/audit/DRIFT_ASSERTIONS.md` | Existing | Refresh in this cycle |
| Drift Report | `products/entropy-core/docs/audit/DRIFT_REPORT.md` | Existing | Refresh in this cycle |
| Adversarial Review | `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md` | Existing | Refresh in this cycle |
| Phase 1A closure | `products/entropy-core/docs/audit/archive/phase1a/PHASE1A_SCAFFOLD_CLOSURE_REVIEW.md` | Complete | Scaffold/probe chain closed; no evaluation approval |
| Post-Phase-1A strategy | `products/entropy-core/docs/audit/archive/phase1a/POST_PHASE1A_STRATEGY_REVIEW.md` | Complete | Selects audit-readiness and deep review as next stage |
...
- Evidence: `src/entropy/baseline/governed.py`, `src/entropy/baseline/report.py`,
  `products/entropy-core/docs/tasks.md`, `REVIEW_REPORT.md`
...
- Evidence: `src/entropy/baseline/report.py`, `tests/unit/test_phase1i_j_k_packets.py`
...
- Evidence: `AUDIT_INDEX.md`, `products/entropy-core/docs/audit/README.md`
...
|---|---|---|---|
| Step 1 (Meta) | `products/entropy-core/docs/audit/PROMPT_0_META.md` + `review_pipeline.md` | `products/entropy-core/docs/audit/META_ANALYSIS.md` | Current docs, audit index, review report, Phase 1A packets |
| Step 2 (Architecture) | `products/entropy-core/docs/audit/PROMPT_1_ARCH_REVIEW.md` | `products/entropy-core/docs/audit/ARCH_MODEL.md` | META_ANALYSIS.md + canonical docs |
| Step 3 (Invariants) | `products/entropy-core/docs/audit/PROMPT_2_INVARIANTS.md` | `products/entropy-core/docs/audit/INVARIANTS.md` | ARCH_MODEL.md + canonical docs |
| Step 4 (Drift) | `products/entropy-core/docs/audit/PROMPT_3_DRIFT_GUARD.md` | `DRIFT_ASSERTIONS.md` + `DRIFT_REPORT.md` | INVARIANTS.md + current docs |
| Step 5 (Adversarial) | `products/entropy-core/docs/audit/PROMPT_4_ADVERSARIAL.md` | `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md` | ARCH_MODEL + INVARIANTS + DRIFT_REPORT + canonical docs |
| Step 6 (Consolidated) | `products/entropy-core/docs/audit/PROMPT_5_CONSOLIDATED.md` | `products/entropy-core/docs/audit/REVIEW_REPORT.md` | all prior artifacts + tasks.md + AUDIT_INDEX.md |
