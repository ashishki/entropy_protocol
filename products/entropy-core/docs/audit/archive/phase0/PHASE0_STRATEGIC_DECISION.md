...
- `products/entropy-core/docs/audit/PHASE0_FOUNDATION_REVIEW.md`
- `products/entropy-core/docs/audit/POST_PHASE_STRATEGY_REVIEW.md`
...
- updates to `products/entropy-core/docs/EVIDENCE_INDEX.md`
...
- updates to `products/entropy-core/docs/ARCHITECTURE.md`
- updates to `products/entropy-core/docs/spec.md`
- updates to `products/entropy-core/docs/tasks.md`
- updates to `products/entropy-core/docs/EVIDENCE_INDEX.md`
...
- human approval or rejection recorded in `products/entropy-core/docs/DECISION_LOG.md`
- `products/entropy-core/docs/CODEX_PROMPT.md` updated to the first approved post-gate task
