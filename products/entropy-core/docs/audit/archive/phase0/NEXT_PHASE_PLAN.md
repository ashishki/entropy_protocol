...
Canonical decision artifact: `products/entropy-core/docs/audit/PHASE0_STRATEGIC_DECISION.md`.
...
- `products/entropy-core/docs/audit/PHASE0_EXIT_GAP_REGISTER.md` — complete
- `products/entropy-core/docs/EVIDENCE_INDEX.md` points to the register — complete
- `products/entropy-core/docs/CODEX_PROMPT.md` names the next approved task — complete; next task is P0.5-002
...
- `products/entropy-core/docs/audit/FORMULA_EVIDENCE_DEBT.md` — complete
...
- `products/entropy-core/docs/audit/SHARPE_CI_REVIEW.md` — complete; `CI-SR-ACF-v1` requires revision before gate/report use
- `products/entropy-core/docs/audit/HARVEY_LIU_REVIEW.md` — complete; `HL-HB-v1` is blocked for gate use
...
- `products/entropy-core/docs/audit/PURGE_EMBARGO_DECISION.md` — complete
...
- `products/entropy-core/docs/audit/P4_GATE_DECISION.md` — complete; implementation/evidence selected
...
- `products/entropy-core/docs/audit/SIMBROKER_CALIBRATION_PLAN.md` — complete
...
- `products/entropy-core/docs/audit/DATA_STABILITY_PLAN.md` — complete
...
- `products/entropy-core/docs/ARCHITECTURE.md` updated with Phase 0.5 status — complete
- `products/entropy-core/docs/spec.md` updated with implemented/provisional/gate-missing status — complete
- `products/entropy-core/docs/tasks.md` updated with executable Phase 0.5 task graph — complete
- `products/entropy-core/docs/EVIDENCE_INDEX.md` updated with Phase 0.5 evidence expectations — complete
...
- `products/entropy-core/docs/audit/PHASE0_GATE_PACKET.md` — complete
- `products/entropy-core/docs/DECISION_LOG.md` gate decision entry — complete in D-025
- `products/entropy-core/docs/CODEX_PROMPT.md` updated to the first approved post-gate task — complete; next task is P0.6-001

## Required Documents

Create or update during Phase 0.5:

- `products/entropy-core/docs/audit/PHASE0_EXIT_GAP_REGISTER.md`
- `products/entropy-core/docs/audit/FORMULA_EVIDENCE_DEBT.md`
- `products/entropy-core/docs/audit/SHARPE_CI_REVIEW.md`
- `products/entropy-core/docs/audit/HARVEY_LIU_REVIEW.md`
- `products/entropy-core/docs/audit/PURGE_EMBARGO_DECISION.md`
- `products/entropy-core/docs/audit/P4_GATE_DECISION.md`
- `products/entropy-core/docs/audit/SIMBROKER_CALIBRATION_PLAN.md`
- `products/entropy-core/docs/audit/DATA_STABILITY_PLAN.md`
- `products/entropy-core/docs/audit/PHASE0_GATE_PACKET.md`
