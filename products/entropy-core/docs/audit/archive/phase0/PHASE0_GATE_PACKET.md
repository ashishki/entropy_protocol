...
|----------|--------|------|
| `products/entropy-core/docs/audit/PHASE0_STRATEGIC_DECISION.md` | Complete | D-021 selected Phase 0.5 instead of Phase 1 |
| `products/entropy-core/docs/audit/PHASE0_EXIT_GAP_REGISTER.md` | Complete | Maps canonical exit criteria to evidence gaps |
| `products/entropy-core/docs/audit/FORMULA_EVIDENCE_DEBT.md` | Complete | Ranks formula/evidence debt |
| `products/entropy-core/docs/audit/SHARPE_CI_REVIEW.md` | Complete | D-022 CI revise-required |
| `products/entropy-core/docs/audit/HARVEY_LIU_REVIEW.md` | Updated | P0.6-005 Harvey-Liu family workflow implemented; statistical report packet accepted in P0.7-026 |
| `products/entropy-core/docs/audit/PURGE_EMBARGO_DECISION.md` | Complete | D-023 embargo scaffold-only |
| `products/entropy-core/docs/audit/P4_GATE_DECISION.md` | Complete | D-024 implement/evidence P4 |
| `products/entropy-core/docs/audit/SIMBROKER_CALIBRATION_PLAN.md` | Complete | Future calibration evidence packet plan |
| `products/entropy-core/docs/audit/DATA_STABILITY_PLAN.md` | Complete | Future 90-day monitoring evidence packet plan |
| `products/entropy-core/docs/audit/ARCHIVE_ONLY_EVIDENCE_MODE_DECISION.md` | Complete | D-027 restricts current work to archive-only evidence |
| `products/entropy-core/docs/audit/DATA_STABILITY_ARCHIVE_PACKET.md` | Complete | Archive-mode data-stability packet |
| `products/entropy-core/docs/ARCHITECTURE.md`; `products/entropy-core/docs/spec.md`; `products/entropy-core/docs/tasks.md` | Updated | Phase 0.5 reality sync |
...
- P4 label coverage: `P4-REVISED-FIRST15-COVERAGE-v1` accepted by
  `products/entropy-core/docs/audit/P4_COVERAGE_PACKET_REVIEW.md` with 15/15 passing assets, 157
...
- SimBroker calibration: D-026 approved agent-assisted deterministic
  verification; `products/entropy-core/docs/audit/SIMBROKER_AGENT_VERIFIED_CALIBRATION_PACKET.md`
  records 100/100 included rows passing within the 15% bid/ask criterion across
  5 assets.
- Registered leakage/temporal-shuffling: `products/entropy-core/docs/audit/REGISTERED_LEAKAGE_GATE_PACKET.md`
...
- P1 circuit breaker implementation: T22 governance tests are indexed in
  `products/entropy-core/docs/EVIDENCE_INDEX.md` and cover trip/reset/block/idempotency behavior.
