...
- `products/entropy-core/docs/core/PROTOCOL_SPEC.md` v1.8
- `products/entropy-core/docs/core/CHARTER.md` v5.3
- `products/entropy-core/docs/core/GLOSSARY.md` v1.4
- `products/entropy-core/docs/audit/D010_CLOSURE_PACKET.md`
...
- updating `products/entropy-core/docs/CODEX_PROMPT.md` to name T15 as the next task
