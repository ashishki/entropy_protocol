...
**Filename:** `products/entropy-core/docs/audit/QUESTION_POOL.md`
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/ARCH_MODEL.md`, `products/entropy-core/docs/audit/INVARIANTS.md`, `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`, `products/entropy-core/docs/core/CHARTER.md`
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/ARCH_MODEL.md`, `products/entropy-core/docs/audit/INVARIANTS.md`, `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/ARCH_MODEL.md`, `products/entropy-core/docs/audit/INVARIANTS.md`, `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/ARCH_MODEL.md`, `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** invariant proof
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/INVARIANTS.md`, `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`, `products/entropy-core/docs/core/GLOSSARY.md`
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/audit/ARCH_MODEL.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`, `products/entropy-core/docs/audit/review_pipeline.md`
**Suggested method:** threat model
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/ARCH_MODEL.md`, `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`, `products/entropy-core/docs/core/CHARTER.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** threat model
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** invariant proof
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`, `products/entropy-core/docs/core/CHARTER.md`
**Suggested method:** literature check
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/INVARIANTS.md`, `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/INVARIANTS.md`, `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/CHARTER.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** invariant proof
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/ARCH_MODEL.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** threat model
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/ARCH_MODEL.md`, `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/ARCH_MODEL.md`, `products/entropy-core/docs/audit/INVARIANTS.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** invariant proof
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/audit/INVARIANTS.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`, `products/entropy-core/docs/core/CHARTER.md`
**Suggested method:** invariant proof
**Expected deliverable:** Unified metric definition + conformance lint checklist for products/entropy-core/docs/reports.
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/audit/INVARIANTS.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/CHARTER.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/DRIFT_REPORT.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/audit/ARCH_MODEL.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`, `products/entropy-core/docs/core/CHARTER.md`
**Suggested method:** literature check
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/ARCH_MODEL.md`, `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/core/CHARTER.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `products/entropy-core/docs/audit/REVIEW_REPORT.md`, `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`, `products/entropy-core/docs/core/PROTOCOL_SPEC.md`
**Suggested method:** invariant proof
