...
| P1 | Long-only baseline operations graph | Turn the next work into ordered tasks with dependencies | `products/entropy-core/docs/tasks.md` Phase 1B section | Alpha execution and backtest |
...
| P8 | Implementation contract | Define bounded implementation rules before executable baseline logic | `products/entropy-core/docs/tasks.md` Phase 1D section | Executable logic until approved |
| P9 | D-K research roadmap | Keep implementation/evaluation/report/decision/holdout sequence explicit | `products/entropy-core/docs/tasks.md` Phase 1 Research Roadmap | Blanket approval by implication |
