...
| Artifact | Role |
|----------|------|
| `products/entropy-core/docs/core/PROTOCOL_SPEC.md` Harvey-Liu Haircut Method | Canonical workflow |
| `products/entropy-core/docs/core/GLOSSARY.md` Deflated Sharpe | Canonical report fields and interpretation |
| `products/entropy-core/docs/audit/D010_CLOSURE_PACKET.md` F-1 | Audit closure rationale and evidence requirements |
