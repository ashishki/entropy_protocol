...
| `products/entropy-core/docs/spec.md` Walk-Forward Harness | Implementation-facing Phase 0 behavior |
| `products/entropy-core/docs/ARCHITECTURE.md` Phase 0 Run Path | Evaluation run path and leakage boundary |
| `products/entropy-core/docs/core/PROTOCOL_SPEC.md` Phase 0 / research questions | Canonical leakage and walk-forward context |
| `products/entropy-core/docs/audit/PHASE0_EXIT_GAP_REGISTER.md` EC-01 | Gate gap tied to registered leakage evidence |
| `products/entropy-core/docs/audit/FORMULA_EVIDENCE_DEBT.md` FD-07 | Purge/embargo debt ranking |
