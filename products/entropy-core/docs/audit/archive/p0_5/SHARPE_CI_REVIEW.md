...
| Artifact | Role |
|----------|------|
| `products/entropy-core/docs/core/PROTOCOL_SPEC.md` Net Sharpe / `CI-SR-ACF-v1` | Canonical formula and report-field contract |
| `products/entropy-core/docs/core/GLOSSARY.md` Net Sharpe | Canonical interpretation rule |
| `products/entropy-core/docs/audit/D010_CLOSURE_PACKET.md` F-2 | Audit closure rationale and required evidence |
| `products/entropy-core/docs/audit/T23_FORMULA_GOVERNANCE_DISPOSITION.md` | Narrow permission for provisional helper |
