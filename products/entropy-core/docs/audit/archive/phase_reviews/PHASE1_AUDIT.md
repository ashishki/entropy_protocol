...
[A4-12] — PASS — products/entropy-core/docs/nfr.md not present in declared file layout; check not applicable
...
[A5-14] — PASS — RAG Profile OFF; products/entropy-core/docs/retrieval_eval.md not required
[A5-15] — PASS — Tool-Use Profile OFF; products/entropy-core/docs/tool_eval.md not required
[A5-16] — PASS — Agentic Profile OFF; products/entropy-core/docs/agent_eval.md not required
[A5-17] — PASS — Planning Profile OFF; products/entropy-core/docs/plan_eval.md not required
[A5-18] — PASS — Compliance Profile OFF; products/entropy-core/docs/compliance_eval.md not required
[A5b-01] — PASS — products/entropy-core/docs/DECISION_LOG.md present; all 8 rows point to canonical sources (ARCHITECTURE.md or IMPLEMENTATION_CONTRACT.md)
[A5b-02] — PASS — products/entropy-core/docs/IMPLEMENTATION_JOURNAL.md present; initialized with append-only entry template; first entry dated 2026-05-01 with canonical refs
[A5b-03] — PASS — products/entropy-core/docs/EVIDENCE_INDEX.md present; all rows point to test function artifacts; preamble correctly declares retrieval-convenience-only status
...
[B-08c] — PASS — products/entropy-core/docs/nfr.md not present; NFR consistency check not applicable
