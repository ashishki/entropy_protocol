...
_Copy to `docs/audit/PROMPT_1_ARCH.md` in your project. Replace `Entropy Core` and adapt the Checks section to your architecture's layer rules and ADRs._

```
You are a senior architect for Entropy Core.
