...
**Filename:** `products/entropy-core/docs/audit/review_pipeline.md`
...
No audit is complete unless all six steps have been executed and their outputs committed to `products/entropy-core/docs/audit/`.

---

## Artifact Discovery Rule

**Before each step begins, the executing agent must scan `products/entropy-core/docs/audit/` for existing artifacts matching the step's output filename(s).**
...
**Inputs:**
- All documents in `products/entropy-core/docs/` (CHARTER.md, PROTOCOL_SPEC.md, GLOSSARY.md, EVOLUTION.md, audience briefs, README.md)
...
**Output:** `products/entropy-core/docs/audit/META_ANALYSIS.md`
...
**Output:** `products/entropy-core/docs/audit/ARCH_MODEL.md`
...
**Output:** `products/entropy-core/docs/audit/INVARIANTS.md`
...
**Inputs:**
- All docs in `products/entropy-core/docs/`
...
**Outputs:**
- `products/entropy-core/docs/audit/DRIFT_ASSERTIONS.md` — structured list: `[invariant_id] [PASS / FAIL / AMBIGUOUS] [evidence pointer]`
- `products/entropy-core/docs/audit/DRIFT_REPORT.md` — prose analysis of failures and ambiguities, severity-ranked
...
**Output:** `products/entropy-core/docs/audit/ADVERSARIAL_REVIEW.md`
...
- Existing `products/entropy-core/docs/tasks.md` (to map findings to existing tasks or create new ones)
- Existing `products/entropy-core/docs/audit/AUDIT_INDEX.md` (to register this cycle)
...
3. For each P0/P1 finding: state the acceptance criterion (what spec change or test result closes the finding). Link to `products/entropy-core/docs/tasks.md` entry.
4. Produce "Converted Backlog Items" table mapping finding IDs to task IDs.
5. Update the "Converted Backlog Items" in `products/entropy-core/docs/tasks.md`.

**Output:** `products/entropy-core/docs/audit/REVIEW_REPORT.md`

**Acceptance criterion:** Every finding has a severity, evidence pointer, next action, and acceptance criterion. Every P0/P1 finding has a corresponding `products/entropy-core/docs/tasks.md` entry.
...
3. `products/entropy-core/docs/audit/review_pipeline.md` (this document)
4. `products/entropy-core/docs/audit/AUDIT_INDEX.md`

### Step sequencing rules

- Steps must run **in order**: Step 2 cannot begin until Step 1's output is committed to `products/entropy-core/docs/audit/`.
...
See `products/entropy-core/docs/audit/AUDIT_INDEX.md` for naming conventions. Canonical filenames (e.g., `REVIEW_REPORT.md`) are overwritten each full-pipeline cycle. Versioned snapshots (e.g., `2026-03-04_phase0_REVIEW_REPORT_v1.md`) are created by the Step 6 agent and registered in the History section of `AUDIT_INDEX.md`.
