...
- Active task: T13 Hypothesis Backtest Bridge Design
- Phase: 4 Product Bridges
- Last validation: 2026-05-07 T12: `322 passed, 20 skipped`; ruff check clean; ruff format check clean; pyright 0 errors; `git diff --check` clean.
- Git status summary: T12 local changes pending commit at handoff update time.
