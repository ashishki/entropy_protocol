...
**Файл:** `docs/audience/ARCHITECT_BRIEF.md`
...
1. `docs/core/PROTOCOL_SPEC.md`
2. `docs/core/CHARTER.md`
3. `docs/architecture/system_architecture.md`
4. `docs/architecture/workflow_ai_development.md`
5. `docs/audit/REVIEW_REPORT.md`
