...
|---|---|---|---|---|
| Meta Investigation | `docs/audit/META_ANALYSIS.md` | Draft | 2026-05-05 | Cycle 3, Post-Phase0 Archive-Only |
| Architecture Review | `docs/audit/ARCH_MODEL.md` | Draft | 2026-05-05 | Cycle 3, Post-Phase0 Archive-Only |
| Invariant Extraction | `docs/audit/INVARIANTS.md` | Draft | 2026-05-05 | Cycle 3, Post-Phase0 Archive-Only |
| Drift Assertions | `docs/audit/DRIFT_ASSERTIONS.md` | Draft | 2026-05-05 | Cycle 3, Post-Phase0 Archive-Only |
| Drift Report | `docs/audit/DRIFT_REPORT.md` | Draft | 2026-05-05 | Cycle 3, Post-Phase0 Archive-Only |
| Adversarial Review | `docs/audit/ADVERSARIAL_REVIEW.md` | Draft | 2026-05-05 | Cycle 3, Post-Phase0 Archive-Only |
| Consolidated Review | `docs/audit/REVIEW_REPORT.md` | Draft | 2026-05-05 | Cycle 3, Post-Phase0 Archive-Only |
...
| T22 Governance Disposition | `docs/audit/T22_GOVERNANCE_DISPOSITION.md` | Draft | 2026-05-05 | Phase 8 |
| Phase 8 Boundary Review | `docs/audit/PHASE8_REVIEW.md` | Draft | 2026-05-05 | Phase 8 Boundary |
| T23 Formula-Governance Disposition | `docs/audit/T23_FORMULA_GOVERNANCE_DISPOSITION.md` | Draft | 2026-05-05 | Phase 9 |
| T24 Exit-Artifacts Disposition | `docs/audit/T24_EXIT_ARTIFACTS_DISPOSITION.md` | Draft | 2026-05-05 | Phase 9 |
| Phase 0 Foundation Review | `docs/audit/PHASE0_FOUNDATION_REVIEW.md` | Draft | 2026-05-05 | Post-T24 |
| Post-Phase Strategy Review | `docs/audit/POST_PHASE_STRATEGY_REVIEW.md` | Draft | 2026-05-05 | Post-T24 |
| Phase 0 Strategic Decision | `docs/audit/PHASE0_STRATEGIC_DECISION.md` | Draft | 2026-05-05 | PSR-002 |
| Phase 0 Exit Gap Register | `docs/audit/PHASE0_EXIT_GAP_REGISTER.md` | Draft | 2026-05-05 | P0.5-001 |
| Formula Evidence Debt Register | `docs/audit/FORMULA_EVIDENCE_DEBT.md` | Draft | 2026-05-05 | P0.5-002 |
| Sharpe CI Review | `docs/audit/SHARPE_CI_REVIEW.md` | Draft | 2026-05-05 | P0.5-003 |
| Harvey-Liu Review | `docs/audit/HARVEY_LIU_REVIEW.md` | Draft | 2026-05-05 | P0.6-005 |
| Purge Embargo Decision | `docs/audit/PURGE_EMBARGO_DECISION.md` | Draft | 2026-05-05 | P0.5-004 |
| P4 Gate Decision | `docs/audit/P4_GATE_DECISION.md` | Draft | 2026-05-05 | P0.5-005 |
| SimBroker Calibration Plan | `docs/audit/SIMBROKER_CALIBRATION_PLAN.md` | Draft | 2026-05-05 | P0.6-006 |
| Data Stability Plan | `docs/audit/DATA_STABILITY_PLAN.md` | Draft | 2026-05-05 | P0.6-007 |
| Architecture And Spec Reality Sync | `docs/ARCHITECTURE.md`; `docs/spec.md`; `docs/tasks.md`; `docs/EVIDENCE_INDEX.md` | Draft | 2026-05-05 | P0.5-008 |
| Phase 0 Gate Packet | `docs/audit/PHASE0_GATE_PACKET.md` | Draft | 2026-05-05 | P0.5-009 |
| Next Phase Plan | `docs/audit/NEXT_PHASE_PLAN.md` | Draft | 2026-05-05 | Post-T24 |
| Evidence Collection Authorization | `docs/audit/EVIDENCE_COLLECTION_AUTHORIZATION.md` | Draft | 2026-05-05 | P0.6-008 |
| Evidence Source Selection | `docs/audit/EVIDENCE_SOURCE_SELECTION.md` | Draft | 2026-05-05 | P0.6-HUMAN-001 |
| Crypto Universe Snapshot | `docs/audit/CRYPTO_UNIVERSE_SNAPSHOT.md` | Draft | 2026-05-05 | P0.7-001 |
| Source Manifest Bootstrap | `docs/audit/SOURCE_MANIFEST_BOOTSTRAP.md` | Draft | 2026-05-05 | P0.7-001 |
| Binance P4 Canary | `docs/audit/BINANCE_P4_CANARY.md` | Draft | 2026-05-05 | P0.7-002 |
| P4 Coverage Scale Plan | `docs/audit/P4_COVERAGE_SCALE_PLAN.md` | Draft | 2026-05-05 | P0.7-003 |
| P4 Coverage Scale Manifest | `docs/audit/P4_COVERAGE_SCALE_MANIFEST.json` | Draft | 2026-05-05 | P0.7-003 |
| P4 First Batch Collection | `docs/audit/P4_FIRST_BATCH_COLLECTION.md` | Draft | 2026-05-05 | P0.7-004 |
| P4 Coverage Packet Review | `docs/audit/P4_COVERAGE_PACKET_REVIEW.md` | Draft | 2026-05-05 | P0.7-016 |
| Phase 0 Gate Packet Sync | `docs/audit/PHASE0_GATE_PACKET.md` | Draft | 2026-05-05 | P0.7-017 |
| SimBroker Calibration Bootstrap | `docs/audit/SIMBROKER_CALIBRATION_BOOTSTRAP.md` | Draft | 2026-05-05 | P0.7-018 |
| SimBroker Calibration Candidate Row Plan | `docs/audit/SIMBROKER_CALIBRATION_CANDIDATE_ROW_PLAN.md` | Draft | 2026-05-05 | P0.7-019 |
| SimBroker Calibration Dry Run | `docs/audit/SIMBROKER_CALIBRATION_DRY_RUN.md` | Draft | 2026-05-05 | P0.7-020 |
| Data Stability Bootstrap | `docs/audit/DATA_STABILITY_BOOTSTRAP.md` | Draft | 2026-05-05 | P0.7-021 |
| Data Stability Simulation | `docs/audit/DATA_STABILITY_SIMULATION.md` | Draft | 2026-05-05 | P0.7-022 |
| Daily Stability Append Procedure | `docs/audit/DAILY_STABILITY_APPEND_PROCEDURE.md` | Draft | 2026-05-05 | P0.7-022 |
| SimBroker Agent-Assisted Verification Decision | `docs/audit/SIMBROKER_AGENT_ASSISTED_VERIFICATION_DECISION.md` | Draft | 2026-05-05 | P0.7-022 |
| SimBroker Agent-Verified Calibration Packet | `docs/audit/SIMBROKER_AGENT_VERIFIED_CALIBRATION_PACKET.md` | Draft | 2026-05-05 | P0.7-023 |
| Data Stability Live Append Tooling | `docs/audit/DATA_STABILITY_LIVE_APPEND_TOOLING.md` | Draft | 2026-05-05 | P0.7-024 |
| Registered Leakage Gate Packet | `docs/audit/REGISTERED_LEAKAGE_GATE_PACKET.md` | Draft | 2026-05-05 | P0.7-025 |
| Statistical Report Gate Packet | `docs/audit/STATISTICAL_REPORT_GATE_PACKET.md` | Draft | 2026-05-05 | P0.7-026 |
| Archive-Only Evidence Mode Decision | `docs/audit/ARCHIVE_ONLY_EVIDENCE_MODE_DECISION.md` | Draft | 2026-05-05 | P0.7-028 |
| Data Stability Archive Packet | `docs/audit/DATA_STABILITY_ARCHIVE_PACKET.md` | Draft | 2026-05-05 | P0.7-028 |
| Phase 0 Final Sync | `docs/audit/PHASE0_FINAL_SYNC.md` | Draft | 2026-05-05 | P0.7-028 |
| Archive-Only Continuation Decision | `docs/audit/ARCHIVE_ONLY_CONTINUATION_DECISION.md` | Draft | 2026-05-05 | PSR-003 |
| Phase 1A Archive Entry Contract | `docs/audit/PHASE1A_ARCHIVE_ENTRY_CONTRACT.md` | Draft | 2026-05-05 | P1A-001 |
| Phase 1A Archive Freeze Packet | `docs/audit/PHASE1A_ARCHIVE_FREEZE_PACKET.md` | Draft | 2026-05-05 | P1A-002 |
| Phase 1A Registration Boundary Packet | `docs/audit/PHASE1A_REGISTRATION_BOUNDARY_PACKET.md` | Draft | 2026-05-05 | P1A-003 |
| Phase 1A Baseline Registration Packet | `docs/audit/PHASE1A_BASELINE_REGISTRATION_PACKET.md` | Draft | 2026-05-05 | P1A-004 |
| Phase 1A Fix Closure Review | `docs/audit/PHASE1A_FIX_CLOSURE_REVIEW.md` | Draft | 2026-05-05 | P1A-005 |
...
|---|---|---|---|
| Phase 1A Fix Closure Review | `docs/audit/PHASE1A_FIX_CLOSURE_REVIEW.md` | Draft | D-033 |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Phase 1A Baseline Registration Packet | `docs/audit/PHASE1A_BASELINE_REGISTRATION_PACKET.md` | Draft | D-032 |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Phase 1A Registration Boundary Packet | `docs/audit/PHASE1A_REGISTRATION_BOUNDARY_PACKET.md` | Draft | D-031 |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Phase 1A Archive Freeze Packet | `docs/audit/PHASE1A_ARCHIVE_FREEZE_PACKET.md` | Draft | D-030 |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Phase 1A Archive Entry Contract | `docs/audit/PHASE1A_ARCHIVE_ENTRY_CONTRACT.md` | Draft | D-029 |
| Consolidated Review | `docs/audit/REVIEW_REPORT.md` | Draft | F-C3-001 through F-C3-006 closed by contract |
...
|---|---|---|---|
| Meta Investigation | `docs/audit/META_ANALYSIS.md` | `2026-05-05_phase0_archive_META_ANALYSIS_v3.md` | Draft |
| Architecture Review | `docs/audit/ARCH_MODEL.md` | `2026-05-05_phase0_archive_ARCH_MODEL_v3.md` | Draft |
| Invariant Extraction | `docs/audit/INVARIANTS.md` | `2026-05-05_phase0_archive_INVARIANTS_v3.md` | Draft |
| Drift Assertions | `docs/audit/DRIFT_ASSERTIONS.md` | `2026-05-05_phase0_archive_DRIFT_ASSERTIONS_v3.md` | Draft |
| Drift Report | `docs/audit/DRIFT_REPORT.md` | `2026-05-05_phase0_archive_DRIFT_REPORT_v3.md` | Draft |
| Adversarial Review | `docs/audit/ADVERSARIAL_REVIEW.md` | `2026-05-05_phase0_archive_ADVERSARIAL_REVIEW_v3.md` | Draft |
| Consolidated Review | `docs/audit/REVIEW_REPORT.md` | `2026-05-05_phase0_archive_REVIEW_REPORT_v3.md` | Draft |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Archive-Only Continuation Decision | `docs/audit/ARCHIVE_ONLY_CONTINUATION_DECISION.md` | Draft | D-028 |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Archive-Only Evidence Mode Decision | `docs/audit/ARCHIVE_ONLY_EVIDENCE_MODE_DECISION.md` | Draft | D-027 scope decision |
| Data Stability Archive Packet | `docs/audit/DATA_STABILITY_ARCHIVE_PACKET.md` | Draft | Archive data-stability acceptance |
...
| Phase 0 Final Sync | `docs/audit/PHASE0_FINAL_SYNC.md` | Draft | Archive-only final gate disposition |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Phase 0 Final Sync | `docs/audit/PHASE0_FINAL_SYNC.md` | Draft | Final blocker state |
| Phase 0 Gate Packet | `docs/audit/PHASE0_GATE_PACKET.md` | Draft | Updated gate state |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Statistical Report Gate Packet | `docs/audit/STATISTICAL_REPORT_GATE_PACKET.md` | Draft | Packet acceptance |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Registered Leakage Gate Packet | `docs/audit/REGISTERED_LEAKAGE_GATE_PACKET.md` | Draft | Packet acceptance |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Data Stability Live Append Tooling | `docs/audit/DATA_STABILITY_LIVE_APPEND_TOOLING.md` | Draft | Tooling result and first append |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Agent-Assisted Verification Decision | `docs/audit/SIMBROKER_AGENT_ASSISTED_VERIFICATION_DECISION.md` | Draft | D-026 owner approval |
| Agent-Verified Calibration Packet | `docs/audit/SIMBROKER_AGENT_VERIFIED_CALIBRATION_PACKET.md` | Draft | 100-row packet acceptance |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Data Stability Simulation | `docs/audit/DATA_STABILITY_SIMULATION.md` | Draft | 90-day fixture simulation |
| Daily Stability Append Procedure | `docs/audit/DAILY_STABILITY_APPEND_PROCEDURE.md` | Draft | Real append procedure |
| Agent-Assisted Verification Decision | `docs/audit/SIMBROKER_AGENT_ASSISTED_VERIFICATION_DECISION.md` | Draft | Requires owner approval |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Data Stability Bootstrap | `docs/audit/DATA_STABILITY_BOOTSTRAP.md` | Draft | Day-1 bootstrap and boundary |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| SimBroker Calibration Dry Run | `docs/audit/SIMBROKER_CALIBRATION_DRY_RUN.md` | Draft | Dry-run result and boundary |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| SimBroker Calibration Candidate Row Plan | `docs/audit/SIMBROKER_CALIBRATION_CANDIDATE_ROW_PLAN.md` | Draft | Builder path and no-claim boundary |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| SimBroker Calibration Bootstrap | `docs/audit/SIMBROKER_CALIBRATION_BOOTSTRAP.md` | Draft | Source bootstrap result and boundary |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Phase 0 Gate Packet | `docs/audit/PHASE0_GATE_PACKET.md` | Draft | P4 evidence closure and remaining blocker state |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| P4 Coverage Packet Review | `docs/audit/P4_COVERAGE_PACKET_REVIEW.md` | Draft | Review decision and boundary |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Revised P4 First 15 Coverage Packet | `docs/audit/P4_REVISED_FIRST15_COVERAGE_PACKET.md` | Draft | Human-readable coverage packet candidate |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Revised P4 Batch 002 Collection | `docs/audit/P4_REVISED_BATCH_002_COLLECTION.md` | Draft | Records batch 002 result and no-claim boundary |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Revised P4 Batch 001 Conversion | `docs/audit/P4_REVISED_BATCH_001_CONVERSION.md` | Draft | Records conversion result and no-claim boundary |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Revised P4 Batch 001 Collection | `docs/audit/P4_REVISED_BATCH_001_COLLECTION.md` | Draft | Records batch 001 result and no-claim boundary |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Revised P4 Scale Plan Decision | `docs/audit/P4_REVISED_SCALE_PLAN_DECISION.md` | Draft | Summary of revised matrix |
| Revised P4 Coverage Scale Plan | `docs/audit/P4_REVISED_COVERAGE_SCALE_PLAN.md` | Draft | 1440 planned downloads and resume policy |
| Revised P4 Coverage Scale Manifest | `docs/audit/P4_REVISED_COVERAGE_SCALE_MANIFEST.json` | Draft | Machine-readable revised matrix |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| P4 Universe Revision Decision | `docs/audit/P4_UNIVERSE_REVISION_DECISION.md` | Draft | Decision rationale and replacement map |
| Revised P4 Universe Snapshot | `docs/audit/P4_REVISED_CRYPTO_UNIVERSE_SNAPSHOT.md` | Draft | `PHASE0-CRYPTO-P4-20-v2` snapshot |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| P4 Extended History Eligibility Probe | `docs/audit/P4_EXTENDED_HISTORY_ELIGIBILITY_PROBE.md` | Draft | Current universe and legacy candidate probe summary |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| P4 Coverage Window Strategy Decision | `docs/audit/P4_COVERAGE_WINDOW_STRATEGY_DECISION.md` | Draft | Stops broad 3-year collection and selects eligibility probe |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| BTCUSDT Full-Window Conversion | `docs/audit/P4_BTCUSDT_FULL_WINDOW_CONVERSION.md` | Draft | Records conversion result and strategic finding |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| P4 Batch 002 Collection | `docs/audit/P4_BATCH_002_COLLECTION.md` | Draft | Records batch 002 result and no-claim boundary |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| P4 First Batch Conversion | `docs/audit/P4_FIRST_BATCH_CONVERSION.md` | Draft | Records conversion result and no-claim boundary |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| P4 First Batch Collection | `docs/audit/P4_FIRST_BATCH_COLLECTION.md` | Draft | Records first batch result |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| P4 Coverage Scale Plan | `docs/audit/P4_COVERAGE_SCALE_PLAN.md` | Draft | 720 planned downloads, resume policy, acceptance checks |
| P4 Coverage Scale Manifest | `docs/audit/P4_COVERAGE_SCALE_MANIFEST.json` | Draft | Machine-readable planned download matrix |
| P4 Scale Plan Module | `entropy/evidence/p4_scale_plan.py` | Draft | Deterministic plan builder |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.7-004 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Binance P4 Canary | `docs/audit/BINANCE_P4_CANARY.md` | Draft | Records canary source hash, dataset hash, and P4 result |
...
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.7-003 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Crypto Universe Snapshot | `docs/audit/CRYPTO_UNIVERSE_SNAPSHOT.md` | Draft | Records `PHASE0-CRYPTO-20-v1` and universe hash |
| Source Manifest Bootstrap | `docs/audit/SOURCE_MANIFEST_BOOTSTRAP.md` | Draft | Records canary PASS for approved public domains |
| Crypto Universe Module | `entropy/evidence/crypto_universe.py` | Draft | Machine-readable universe snapshot |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.7-002 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Evidence Collection Authorization | `docs/audit/EVIDENCE_COLLECTION_AUTHORIZATION.md` | Draft | Updated to `APPROVED_LIMITED_FREE_CRYPTO_SOURCES` |
| Evidence Source Selection | `docs/audit/EVIDENCE_SOURCE_SELECTION.md` | Draft | Records `FREE-CRYPTO-SOURCES-v1` rationale |
| Source Selection Module | `entropy/evidence/source_selection.py` | Draft | Machine-readable source/use-case/domain guards |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.7-001 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Evidence Collection Authorization | `docs/audit/EVIDENCE_COLLECTION_AUTHORIZATION.md` | Draft | Records `PENDING_HUMAN_APPROVAL` |
| Phase 0 Gate Packet | `docs/audit/PHASE0_GATE_PACKET.md` | Draft | Sets P0.6-HUMAN-001 as next action |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.6-HUMAN-001 as next action |
| Evidence Index | `docs/EVIDENCE_INDEX.md` | Draft | Points to P0.6-008 packet |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Data Stability Plan | `docs/audit/DATA_STABILITY_PLAN.md` | Draft | Updated from plan-only to tooling-ready/evidence-missing |
| Phase 0 Gate Packet | `docs/audit/PHASE0_GATE_PACKET.md` | Draft | Sets P0.6-008 as next task |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.6-008 as next task |
| Evidence Index | `docs/EVIDENCE_INDEX.md` | Draft | Points to P0.6-007 implementation evidence |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| SimBroker Calibration Plan | `docs/audit/SIMBROKER_CALIBRATION_PLAN.md` | Draft | Updated from plan-only to tooling-ready/evidence-missing |
| Phase 0 Gate Packet | `docs/audit/PHASE0_GATE_PACKET.md` | Draft | Sets P0.6-007 as next task |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.6-007 as next task |
| Evidence Index | `docs/EVIDENCE_INDEX.md` | Draft | Points to P0.6-006 implementation evidence |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Harvey-Liu Review | `docs/audit/HARVEY_LIU_REVIEW.md` | Draft | Updated from blocked helper review to implementation-revised packet-required |
| Phase 0 Gate Packet | `docs/audit/PHASE0_GATE_PACKET.md` | Draft | Sets P0.6-006 as next task |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.6-006 as next task |
| Evidence Index | `docs/EVIDENCE_INDEX.md` | Draft | Points to P0.6-005 implementation evidence |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Phase 0 Gate Packet | `docs/audit/PHASE0_GATE_PACKET.md` | Draft | Records Phase 0 NOT_APPROVED and Phase 0.6 reshape |
| Decision Log | `docs/DECISION_LOG.md` | Draft | D-025 recorded |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.6-001 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Architecture | `docs/ARCHITECTURE.md` | Draft | Adds Phase 0.5 reality and provisional surfaces |
| Feature Spec | `docs/spec.md` | Draft | Adds gate-missing/provisional status |
| Task Graph | `docs/tasks.md` | Draft | Adds Phase 0.5 task graph |
| Evidence Index | `docs/EVIDENCE_INDEX.md` | Draft | Points to P0.5-008 |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Data Stability Plan | `docs/audit/DATA_STABILITY_PLAN.md` | Draft | Defines future >=90 continuous days monitoring packet |
| Evidence Index | `docs/EVIDENCE_INDEX.md` | Draft | Points to the stability plan |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.5-008 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| SimBroker Calibration Plan | `docs/audit/SIMBROKER_CALIBRATION_PLAN.md` | Draft | Defines future >=100 manually verified bid/ask fill evidence packet |
| Evidence Index | `docs/EVIDENCE_INDEX.md` | Draft | Points to the calibration plan |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.5-007 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| P4 Gate Decision | `docs/audit/P4_GATE_DECISION.md` | Draft | Selects implementation/evidence path; no charter revision yet |
| Decision Log | `docs/DECISION_LOG.md` | Draft | D-024 recorded |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.5-006 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Purge Embargo Decision | `docs/audit/PURGE_EMBARGO_DECISION.md` | Draft | Retains T18 embargo as scaffold only; blocks Phase 1 OOS claims until derived methodology exists |
| Decision Log | `docs/DECISION_LOG.md` | Draft | D-023 recorded |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.5-005 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Sharpe CI Review | `docs/audit/SHARPE_CI_REVIEW.md` | Draft | `CI-SR-ACF-v1` requires revision before gate/report use |
| Harvey-Liu Review | `docs/audit/HARVEY_LIU_REVIEW.md` | Draft | `HL-HB-v1` is blocked for gate use |
| Decision Log | `docs/DECISION_LOG.md` | Draft | D-022 recorded |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.5-004 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Formula Evidence Debt | `docs/audit/FORMULA_EVIDENCE_DEBT.md` | Draft | Ranks unresolved formula/evidence surfaces by gate impact |
| Evidence Index | `docs/EVIDENCE_INDEX.md` | Draft | Points to the debt register |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.5-003 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Exit Gap Register | `docs/audit/PHASE0_EXIT_GAP_REGISTER.md` | Draft | Maps each canonical exit criterion to evidence, gaps, owner, blocker status, and closure path |
| Evidence Index | `docs/EVIDENCE_INDEX.md` | Draft | Points to the gap register |
| Codex Prompt | `docs/CODEX_PROMPT.md` | Draft | Sets P0.5-002 as next task |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Strategic Decision | `docs/audit/PHASE0_STRATEGIC_DECISION.md` | Draft | Selects Phase 0.5 Foundation Closure and Evidence Hardening |
| Consolidated Review | `docs/audit/REVIEW_REPORT.md` | Draft | Synchronized next blocker to P0.5-001 |
| Next Phase Plan | `docs/audit/NEXT_PHASE_PLAN.md` | Draft | Rewritten to Phase 0.5 task plan |
| Decision Log | `docs/DECISION_LOG.md` | Draft | D-021 recorded |
...
| Artifact | File | Status | Notes |
|---|---|---|---|
| Consolidated Review | `docs/audit/REVIEW_REPORT.md` | Draft | Updated to current post-T24 Phase 0 foundation state |
| Phase 0 Foundation Review | `docs/audit/PHASE0_FOUNDATION_REVIEW.md` | Draft | Primary foundation checkpoint reference |
| Post-Phase Strategy Review | `docs/audit/POST_PHASE_STRATEGY_REVIEW.md` | Draft | Source of PSR-001/PSR-002 blockers |
| Next Phase Plan | `docs/audit/NEXT_PHASE_PLAN.md` | Draft | Recommends Phase 0 Closure and Hardening before Phase 1 |
