...
| Artifact | Path |
|---|---|
| Revised scale plan | `docs/audit/P4_REVISED_COVERAGE_SCALE_PLAN.md` |
| Revised scale manifest | `docs/audit/P4_REVISED_COVERAGE_SCALE_MANIFEST.json` |
| Revised universe snapshot | `docs/audit/P4_REVISED_CRYPTO_UNIVERSE_SNAPSHOT.md` |
