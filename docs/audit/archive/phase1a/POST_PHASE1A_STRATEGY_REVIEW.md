...
|---|---|---|---|---|---|
| F-C3-007 | P2; blocks next full audit run | `docs/audit/PROMPT_0_META.md` through `PROMPT_5_CONSOLIDATED.md` | Prompt headers and instructions still refer to Cycle 1 pre-development state, which can contaminate the required deep protocol review | codex | P1A-011 Audit Prompt Metadata Refresh |
