...
|--------|--------------------|
| `docs/core/PROTOCOL_SPEC.md` Section F, Phase 0 | Primary Phase 0 exit criteria and Growth Layer build requirements |
| `docs/core/CHARTER.md` Phase 0 | Repeats all required exit criteria and the no-partial-Phase-0 rule |
| `docs/core/GLOSSARY.md` SimBroker / Trial Registry | SimBroker calibration target and Trial Registry semantics |
| `docs/ARCHITECTURE.md` Overview / Phase 0 Run Path | Machine-checkable evidence and no OOS/live-capital boundary |
| `docs/spec.md` Overview / Phase Gate Evidence | Implementation-facing Phase 0 evidence behavior |
| `docs/audit/PHASE0_STRATEGIC_DECISION.md` | D-021 strategic decision selecting Phase 0.5 |
...
| Current artifacts | `entropy/walkforward/splitter.py`; `entropy/walkforward/leakage.py`; `entropy/walkforward/runner.py`; `tests/integration/test_leakage.py`; `tests/integration/test_walk_forward.py`; `docs/EVIDENCE_INDEX.md` |
...
| Current artifacts | `entropy/simbroker/costs.py`; `entropy/simbroker/fills.py`; SimBroker tests listed in `docs/EVIDENCE_INDEX.md` |
...
| Current artifacts | `entropy/models.py`; `entropy/registry/`; `entropy/hashing.py`; migration files; registry tests in `docs/EVIDENCE_INDEX.md` |
...
| Current artifacts | `entropy/data/`; data-pipeline tests listed in `docs/EVIDENCE_INDEX.md` |
...
| Current artifacts | `docs/core/PROTOCOL_SPEC.md` Deterministic P4 Protocol; `docs/core/CHARTER.md`; `docs/core/GLOSSARY.md` |
...
| Current artifacts | `entropy/governance/state_machine.py`; `tests/unit/test_governance.py`; `docs/audit/T22_GOVERNANCE_DISPOSITION.md`; `docs/EVIDENCE_INDEX.md` |
...
1. Use `docs/audit/FORMULA_EVIDENCE_DEBT.md` as the canonical ranking of
