...
|---|---|
| P4 coverage | `docs/audit/P4_COVERAGE_PACKET_REVIEW.md` |
| SimBroker calibration | `docs/audit/SIMBROKER_AGENT_VERIFIED_CALIBRATION_PACKET.md` |
| Archive data stability | `docs/audit/DATA_STABILITY_ARCHIVE_PACKET.md` |
| Leakage/temporal shuffling | `docs/audit/REGISTERED_LEAKAGE_GATE_PACKET.md` |
| Purge/embargo methodology | `docs/audit/REGISTERED_LEAKAGE_GATE_PACKET.md` |
| Statistical report boundary | `docs/audit/STATISTICAL_REPORT_GATE_PACKET.md` |
| Trial registry implementation evidence | `docs/EVIDENCE_INDEX.md` |
| P1 circuit breaker implementation evidence | `docs/EVIDENCE_INDEX.md` |
