...
| Canonical source | `docs/core/PROTOCOL_SPEC.md` Deterministic P4 Protocol and Phase 0 exit criteria |
...
| Current artifact | `docs/audit/PHASE0_EXIT_GAP_REGISTER.md` EC-05 |
...
| Canonical source | `docs/core/PROTOCOL_SPEC.md` Phase 0 exit criteria; `docs/core/GLOSSARY.md` SimBroker |
...
| Current artifact | `docs/audit/PHASE0_EXIT_GAP_REGISTER.md` EC-02 |
...
| Canonical source | `docs/core/PROTOCOL_SPEC.md` Phase 0 exit criteria |
...
| Current artifact | `docs/audit/PHASE0_EXIT_GAP_REGISTER.md` EC-04 |
...
| Canonical source | `docs/core/PROTOCOL_SPEC.md` Phase 0 exit criteria; `docs/spec.md` walk-forward evidence |
...
| Current artifact | `docs/audit/PHASE0_EXIT_GAP_REGISTER.md` EC-01 |
...
| Canonical source | `docs/core/PROTOCOL_SPEC.md` Net Sharpe and CI fields; D-010 F-2 |
...
| Current artifact | `entropy/stats/analysis.py`; `tests/unit/test_stats.py`; `docs/audit/T23_FORMULA_GOVERNANCE_DISPOSITION.md` |
...
| Canonical source | `docs/core/PROTOCOL_SPEC.md` Harvey-Liu section; D-010 F-1 |
...
| Canonical source | `docs/core/PROTOCOL_SPEC.md` Phase 0 track; `docs/audit/PHASE0_STRATEGIC_DECISION.md` |
...
| Current artifact | `entropy/walkforward/splitter.py`; `tests/integration/test_walk_forward.py`; `docs/EVIDENCE_INDEX.md` |
...
| Canonical source | `docs/core/PROTOCOL_SPEC.md` N_eff, K3, Growth Layer Submodule 2; `docs/core/GLOSSARY.md` |
...
| Canonical source | D-010 F-5; `docs/core/PROTOCOL_SPEC.md`; `docs/core/CHARTER.md`; `docs/core/GLOSSARY.md` |
...
| Current artifact | `docs/audit/D010_CLOSURE_PACKET.md`; canonical core docs |
...
| Current artifact | `docs/audit/D010_CLOSURE_PACKET.md`; `docs/EVIDENCE_INDEX.md` |
