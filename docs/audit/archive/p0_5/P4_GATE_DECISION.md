...
| Artifact | Role |
|----------|------|
| `docs/core/PROTOCOL_SPEC.md` Deterministic P4 Protocol | Canonical `P4-RBL-v1` algorithm |
| `docs/core/CHARTER.md` Phase 0 exit criteria / P4 | Gate requirement and governance role |
| `docs/core/GLOSSARY.md` Regime Signal Hierarchy | P4 semantics and state names |
| `docs/audit/PHASE0_EXIT_GAP_REGISTER.md` EC-05 | Current P4 gate gap |
| `docs/audit/FORMULA_EVIDENCE_DEBT.md` FD-01 | P4 ranked as direct gate blocker |
