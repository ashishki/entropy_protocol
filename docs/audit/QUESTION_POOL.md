...
**Recommended files for deep research:** `docs/audit/ARCH_MODEL.md`, `docs/audit/INVARIANTS.md`, `docs/audit/DRIFT_REPORT.md`, `docs/audit/REVIEW_REPORT.md`, `docs/PROTOCOL_SPEC.md`, `docs/CHARTER.md`
...
**Recommended files for deep research:** `docs/audit/ARCH_MODEL.md`, `docs/audit/INVARIANTS.md`, `docs/audit/DRIFT_REPORT.md`, `docs/PROTOCOL_SPEC.md`
...
**Recommended files for deep research:** `docs/audit/ARCH_MODEL.md`, `docs/audit/INVARIANTS.md`, `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/PROTOCOL_SPEC.md`
...
**Recommended files for deep research:** `docs/audit/ARCH_MODEL.md`, `docs/audit/DRIFT_REPORT.md`, `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** invariant proof
...
**Recommended files for deep research:** `docs/audit/INVARIANTS.md`, `docs/audit/DRIFT_REPORT.md`, `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/audit/REVIEW_REPORT.md`, `docs/PROTOCOL_SPEC.md`, `docs/GLOSSARY.md`
...
**Recommended files for deep research:** `docs/audit/DRIFT_REPORT.md`, `docs/audit/REVIEW_REPORT.md`, `docs/audit/ARCH_MODEL.md`, `docs/PROTOCOL_SPEC.md`, `docs/audit/review_pipeline.md`
**Suggested method:** threat model
...
**Recommended files for deep research:** `docs/audit/ARCH_MODEL.md`, `docs/audit/DRIFT_REPORT.md`, `docs/audit/REVIEW_REPORT.md`, `docs/PROTOCOL_SPEC.md`, `docs/CHARTER.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `docs/audit/DRIFT_REPORT.md`, `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/audit/REVIEW_REPORT.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** threat model
...
**Recommended files for deep research:** `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/audit/REVIEW_REPORT.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** invariant proof
...
**Recommended files for deep research:** `docs/audit/DRIFT_REPORT.md`, `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/audit/REVIEW_REPORT.md`, `docs/PROTOCOL_SPEC.md`, `docs/CHARTER.md`
**Suggested method:** literature check
...
**Recommended files for deep research:** `docs/audit/INVARIANTS.md`, `docs/audit/DRIFT_REPORT.md`, `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/audit/REVIEW_REPORT.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `docs/audit/INVARIANTS.md`, `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/audit/REVIEW_REPORT.md`, `docs/CHARTER.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** invariant proof
...
**Recommended files for deep research:** `docs/audit/ARCH_MODEL.md`, `docs/audit/REVIEW_REPORT.md`, `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** threat model
...
**Recommended files for deep research:** `docs/audit/ARCH_MODEL.md`, `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/audit/REVIEW_REPORT.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `docs/audit/ARCH_MODEL.md`, `docs/audit/INVARIANTS.md`, `docs/audit/REVIEW_REPORT.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** invariant proof
...
**Recommended files for deep research:** `docs/audit/DRIFT_REPORT.md`, `docs/audit/REVIEW_REPORT.md`, `docs/audit/INVARIANTS.md`, `docs/PROTOCOL_SPEC.md`, `docs/CHARTER.md`
**Suggested method:** invariant proof
...
**Recommended files for deep research:** `docs/audit/DRIFT_REPORT.md`, `docs/audit/INVARIANTS.md`, `docs/audit/REVIEW_REPORT.md`, `docs/CHARTER.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `docs/audit/DRIFT_REPORT.md`, `docs/audit/REVIEW_REPORT.md`, `docs/audit/ARCH_MODEL.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `docs/audit/REVIEW_REPORT.md`, `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/PROTOCOL_SPEC.md`, `docs/CHARTER.md`
**Suggested method:** literature check
...
**Recommended files for deep research:** `docs/audit/ARCH_MODEL.md`, `docs/audit/REVIEW_REPORT.md`, `docs/CHARTER.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** design comparison
...
**Recommended files for deep research:** `docs/audit/REVIEW_REPORT.md`, `docs/audit/ADVERSARIAL_REVIEW.md`, `docs/PROTOCOL_SPEC.md`
**Suggested method:** invariant proof
