...
**Authority:** This document is subordinate to `docs/core/PROTOCOL_SPEC.md` and `docs/core/CHARTER.md`.
...
- `docs/core/PROTOCOL_SPEC.md` Section E — System Evolution Control subsection
- `docs/core/CHARTER.md` Section B — Frozen Non-Negotiables (the invariants the Governor enforces)
- `docs/governance/research_firewall.md` — the research pipeline the Governor does not govern
- `docs/governance/experiment_readiness_gate.md` — research admission (separate domain from Governor)
- `docs/architecture/system_architecture.md` — Governance Layer and System Evolution Flow
